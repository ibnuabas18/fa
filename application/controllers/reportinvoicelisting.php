<?
	...
	class reportinvoicelisting extends AdminPage{

		function print_invoicelisting()
		{
			
			extract(PopulateForm());
			
			if(@$klik){
			$this->load->view('leasing/print/invoice_listing');
				}else if(@$export){
			$this->load->view('leasing/print/print_listinginvoice_excel');
			}
			...
			//$this->load->view('marketing/print/print_customeraddress');
			//}
		}
		...
		function index(){	
			...
			$data['project'] = $this->db->where('pt_id','12')->get('db_subproject')->result();
			$this->parameters['data'] = $data;
			
			$this->loadTemplate('leasing/reportinvoicelisting_view');
		}
