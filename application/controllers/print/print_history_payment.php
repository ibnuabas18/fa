...
//					$pdf->SetXY(30,82);
			...
			$dt = $this->db->select('kwtbill_id,kwtbill_sisa,id_billing,due_date,id_paygroup,due_date,paygroup_nm,tgl_paydate,amount,kwtbill_pay,kwtbill_paydate,kwtbill_remark,kwtbill_descs,kwtbill_nm')
...
#			var_dump($dt);
			...
			}else if(empty($cekpl->id_billing)){
