<?php
class print_sales_summary_customerprospek extends controller{
	function index(){
			...
			$data1 = $this->db->query("ProspectStatus '" .$salesmanager."','".$start_date1."','" .$end_date1."'");
				$data = $data1->result();
				#var_dump($data);
			
			$query1 = $this->db->query("ProspectInterestProject '" .$salesmanager."','".$start_date1."','" .$end_date1."'");
				$query2 = $query1->result();
				
			$query3 = $this->db->query("ProspectSource '" .$salesmanager."','".$start_date1."','" .$end_date1."'");
			...
			$judul 		= "Prospective Summary Report";
			$periode	= "Periode";
			$mgr		= "Sales Name";
