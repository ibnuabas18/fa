...
class print_cuti_karyawan extends controller{
	function index(){
			...
			if($divisi=="all"){				
				...
				where flowapp_id = 10 and jns_cuti = 1 and datename(YY,startdate_cuti) = '$thn' and db_kary.id_flag != 10
				order by nama asc
				";
			}else{
				$sql = "select * from db_karycuti
				...
				and jns_cuti = 1 and datename(YY,startdate_cuti) = '$thn' and isnull(db_kary.id_flag,0) != 10
				order by nama asc
				";
			}
