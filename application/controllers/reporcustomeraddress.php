<?
	...
	class reporcustomeraddress extends AdminPage{

		function print_customeraddress()
		{
			...
			if(@$klik){
			if($cek==1){
			$this->load->view('marketing/print/print_customeraddress_all');
			}else{
					
			$this->load->view('marketing/print/print_customeraddress');
			}
				}else if(@$export){
			$this->load->view('marketing/excel/print_customeraddress_excel');		
		}
		...
		function index(){	
			...
			$this->loadTemplate('marketing/reporcustomeraddress_view');
		}
