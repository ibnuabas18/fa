<?php
class viewjurnal extends DBController{
	function __construct(){
		parent::__construct('viewjurnal_model');
		$this->set_page_title('View Journal');
		$this->default_limit = 30;
		$this->template_dir = 'gl/viewjurnal';
	...
	function index(){
		...
		$this->set_jqgrid_options_ceklist(array('width'=>1200,'height'=>400,'caption'=>'View Jurnal Transfer','rownumbers'=>true,'sortname'=>'a.gl_id','sortorder'=>'ASC'));
		parent::index();
	}
...
function to_approve(){
	...
	redirect('viewjurnal/approve/'.$id);
	}						
