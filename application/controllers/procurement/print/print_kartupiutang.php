<?php
class print_kartupiutang extends controller{
...
#										$pdf->Cell(20,10,$discount.' + '.$discount2,10,0,'R');
				...
				$pdf->Cell(30,4,$head_nama,0,0,'L',0);
					...
					$pdf->Cell(8,4,':',4,0,'L');
						...
						$pdf->Cell(0,10,$custnama,20,0,'L');
							...
							$pdf->Cell(35,7,$head_top,1,0,'C',0);
							$pdf->Cell(31,7,$head_amount,1,0,'C',0);
							$pdf->Cell(31,7,$head_duedate,1,0,'C',0);
							
							$pdf->Cell(31,7,'Pay Amount',1,0,'C',0);
							$pdf->Cell(31,7,'Balance',1,0,'C',0);
			...
			foreach($data as $row){
				...
				$pdf->Cell(35,4,$row->paygroup_nm.' '.$n.$m,1,0,'L',0);
				$pdf->Cell(31,4,$amount,1,0,'R',0);
				$pdf->Cell(31,4,$duedate,1,0,'C',0);
				$pdf->Cell(31,4,$row->pay_amount,1,0,'C',0);
				$pdf->Cell(31,4,$row->balance_amount,1,0,'C',0);
				...
				$pdf->Cell(43,4,'Total',1,0,'C',0);
				$pdf->Cell(31,4,number_format($totamount),1,0,'R',0);
				$pdf->Cell(31,4,'',1,0,'C',0);
				$pdf->Cell(31,4,number_format($totpay),1,0,'C',0);
				$pdf->Cell(31,4,number_format($totbal),1,0,'C',0);
