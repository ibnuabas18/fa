<?php
class viewcustomer extends DBController{
	function __construct(){
		parent::__construct('spcustomer_model');
		$this->set_page_title('List Customer');
		$this->template_dir = 'sales/viewcustomer';
	...
	function index(){
		...
		$this->set_grid_column('no_sp','No SP',array('width'=>8,'align'=>'right'));
		...
		$this->set_grid_column('nm_subproject','Project',array('width'=>40,'align'=>'left'));
		$this->set_grid_column('paytipe_nm','Payment Type',array('width'=>40,'align'=>'center'));
		$this->set_jqgrid_options(array('width'=>1300,'height'=>300,'caption'=>'List Surat Pesanan','rownumbers'=>true,'sortname'=>'sp_id','sortorder'=>'desc'));
		parent::index();
	}
