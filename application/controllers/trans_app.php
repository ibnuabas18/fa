<?php
class trans_app extends DBController{
	private $divisi;
	function __construct(){
		parent::__construct('trans_app_model');
		$this->set_page_title('Approved Budget');
		$this->template_dir = 'accounting/trans_app';
	...
	function index(){
		...
		$this->set_jqgrid_options(array('width'=>860,'height'=>300,'caption'=>'List of Proposed Budget','rownumbers'=>true));
		parent::index();
	}
