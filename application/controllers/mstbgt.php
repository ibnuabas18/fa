<?php
	class mstbgt extends DBController{
		
		function __construct(){
			// deskripsikan model yg dipakai
			parent::__construct('mstbgt_model');
			$this->set_page_title('Original Operation Budget');
		...
		function index(){
			...
			$this->set_jqgrid_options(array('width'=>2000,'height'=>300,'caption'=>'Original Operation Budget','rownumbers'=>true));
