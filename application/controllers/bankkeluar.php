<?php
	class bankkeluar extends DBController{
		...
		function get_json(){
		//$this->set_custom_function('payment_date','inggris_date');
	//	$this->set_custom_function('slip_date','inggris_date');
		//$this->set_custom_function('trans_date','inggris_date');
		//$this->set_custom_function('paid_date','inggris_date');
		...
		function index(){
			$this->set_grid_column('cash_id','ID',array('hidden'=>true));
			...
			$this->set_jqgrid_options(array('width'=>1250,'height'=>380,'caption'=>'BANK PAYMENT','rownumbers'=>true,'sortname'=>'id_plan','sortorder'=>'DESC'));
			parent::index();		
		}				
		function getdata($id){
