<?
	...
	class reportjurnallisting extends AdminPage{

		function print_jurnallisting()
		{
			
			extract(PopulateForm());
			
			if(@$klik){					
			$this->load->view('gl/print/print_jurnallisting');
			}else{
			$this->load->view('gl/print/print_jurnallisting_excel');		
		}
		...
		function index(){	
			...
			$this->loadTemplate('gl/reportjurnallisting_view');
		}
