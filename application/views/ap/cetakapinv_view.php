...
<h2><font color='red' size='4'>List Invoice AP Vendor<hr width="150px" align="left"></font></h2>
...
<form method="post" action="<?=base_url()?>ap/cetakapinv_call/cetakapinv" target="_blank">
<table>
	<tr>
	<td>Project</td>
	<td>
