...
<body>	
	<table id="tab">
	<tr>
		<h2>EDIT AP INVOICE</h2>		
	</tr>
	<tr>
		<td>AP</td>
			<td>&nbsp;</td>
			<td><input type="text" name="doc_ref" id="doc_ref"  class="validate[required] xinput"  readonly="true" style="width:205px;padding:3px;border:1px solid #cbcbcb;background:#cbcbcb" size="30" value="<?php echo $detail->doc_no;?>" />
			<!--input type="hidden" name="doc_no" id="doc_no"  class="validate[required] xinput" value="<?=$noap?>"  readonly="true" size="30" /--></td>
			<td>Invoice No</td>
			<td>&nbsp;</td>
			<td><input type="text" name="inv_no" id="inv_no" class="validate[required]" size="30" style="width:205px;padding:3px;border:1px solid #cbcbcb" value="<?php echo $detail->inv_no;?>"/></td>
			<td>DPP PPN</td>
			<td>&nbsp;</td>
	...
	<tr>
		<td>Receipt Date</td>
			<td>&nbsp;</td>
			<td>
			<input id="receipt_date" name="receipt_date" style="width:214px;padding:3px;border:1px solid #cbcbcb" size="30" value="<?php echo indo_date($detail->doc_date);?>"></input>
			</td>
			<td>Invoice Date </td>
			<td>&nbsp;</td>
			<td>
			<input id="inv_date" name="inv_date" size="30"  style="width:214px;padding:3px;border:1px solid #cbcbcb" value="<?php echo indo_date($detail->inv_date);?>"></input>
			</td>
			<td>Pph</td>
			<td>&nbsp;</td>
	...
	<td>Vendor Name</td>
			<td>&nbsp;</td>
			<td> 
			<input id="vendor" name="vendor" style="width:214px;padding:3px;border:1px solid #cbcbcb" size="30" value="<?php echo $detail->nm_supplier ;?>" readonly></input>
			

			<!--select name="vendor" id="vendor"  style="width:214px;padding:3px;border:1px solid #cbcbcb">
						<? foreach($vendor as $t): ?>
							<? $banding = $detail->vendor_acct == $t->kd_supp_gb ? "selected" : ""; ?>
							<option value="<?=@$t->kd_supp_gb?>"<?=@$banding;?>><?=@$t->nm_supplier?></option> 
							<? endforeach;?>
	...
	<td>Project</td>
			<td>&nbsp;</td>
			<td>
	<input id="project" name="project" style="width:214px;padding:3px;border:1px solid #cbcbcb" size="30" value="<?php echo $detail->nm_subproject ;?>" readonly></input>
			


			 <!--select name="project" id="project" style="width:214px;padding:3px;border:1px solid #cbcbcb">
						<option>-</option>
                                                            <? 
	...
	<td>Invoice Amount</td>		
			<td>&nbsp;</td>
			<td><input type="text" class="input calculate"  name="amount" id="amount" class="calculate input validate[required]" value="<?php echo number_format($detail->trx_amt);?>" size="30"  style="width:205px;padding:3px;border:1px solid #cbcbcb"/></td>
	<td>PPh (%)</td>
			<td>&nbsp;</td>
	...
	<tr>	<td>AP Category</td>
			<td>&nbsp;</td>
			<td>
			<input id="category" name="category" style="width:214px;padding:3px;border:1px solid #cbcbcb" size="30" value="<?php echo $kelusaha->acc_name ;?>" readonly></input>
	...
	<tr>
			<td>Remark</td>
			<td>&nbsp;</td>
			<td><textarea name="remark" id="remark" class="validate[required] xinput"  size="65"  style="width:205px;padding:3px;border:1px solid #cbcbcb"><?php echo $detail->descs;?></textarea></td>		
...
<table class="datatable">
	...
	<tr id="r1">
		<td align="center"><input type="text" name="acc_dr_1" id="acc_dr_1" class="get_addcoaacno1 mytextbox"></td>
		<td align="center"><input type="text" name="acc_name_1" id="acc_name_1" class="auto-add_name1 mytextbox"></td>
		<td align="right"><input type="text" name="acc_debet_1" id="acc_debet_1" style="text-align:right" class="mytextbox calculate" value=0></td>
		<td align="center"><input type="text" name="acc_credit_1" id="acc_credit_1" style="text-align:right" class="mytextbox calculate"></td>
	</tr>
	<tr id="r2">
		<td align="center"><input type="text" name="acc_dr_2" id="acc_dr_2" class="get_addcoaacno2 mytextbox"></td>
		<td align="center"><input type="text" name="acc_name_2" id="acc_name_2" class="auto-add_name2 mytextbox"></td>
		<td align="right"><input type="text" name="acc_debet_2" id="acc_debet_2" style="text-align:right" class="mytextbox calculate"></td>
		<td align="center"><input type="text" name="acc_credit_2" id="acc_credit_2" style="text-align:right" class="mytextbox calculate" value=0></td>
	</tr>
	<tr id="r3">
		<td align="center"><input type="text" name="acc_dr_3" id="acc_dr_3" class="get_addcoaacno3 mytextbox"></td>
		<td align="center"><input type="text" name="acc_name_3" id="acc_name_3" class="auto-add_name3 mytextbox"></td>
		<td align="right"><input type="text" name="acc_debet_3" id="acc_debet_3" style="text-align:right" class="mytextbox calculate"></td>
		<td align="center"><input type="text" name="acc_credit_3" id="acc_credit_3" style="text-align:right" class="mytextbox calculate" value=0></td>
	</tr>
	<tr id="r4">
		<td align="center"><input type="text" name="acc_dr_4" id="acc_dr_4" class="get_addcoaacno4 mytextbox"></td>
		<td align="center"><input type="text" name="acc_name_4" id="acc_name_4" class="auto-add_name4 mytextbox"></td>
		<td align="right"><input type="text" name="acc_debet_4" id="acc_debet_4" style="text-align:right" class="mytextbox calculate" value=0></td>
		<td align="center"><input type="text" name="acc_credit_4" id="acc_credit_4" style="text-align:right" class="mytextbox calculate"></td>
	</tr>
	...
	<tr height="25px">
		...
		<td align="right"><input type="text" id="total_debet" style="text-align:right;background:lightgray" class="mytextbox calculate"></td>
		<td align="center"><input type="text" id="total_credit" style="text-align:right;background:lightgray" class="mytextbox calculate"></td>
	</tr>
		<!--tr>
		<td align="center" colspan=2>&nbsp;</td>
	...
	<tr>
			...
			<input type="button" value="Cancel" id="close_window"/>
			</td>
	</tr>
</table>
