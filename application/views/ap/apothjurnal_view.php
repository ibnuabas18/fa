...
<?php 
	...
	#$nm_suppl = $this->db->query("select nm_supplier from pemasok where kd_supp_gb = '".$suppl."'")->row()->nm_supplier; 
...
<table class="datatable">
	...
	<tr height="25px">
		...
		<td align="right"><input type="text"   name="acc_debet_1" id="acc_debet_1" class="mytextbox getdeb_value" value="0" style="text-align:right"></td>
		<td align="right"><input type="text"   name="acc_credit_1" id="acc_credit_1" class="mytextbox getcred_value"  value="<?=@number_format($d);?>" style="text-align:right"></td>
	</tr>
	<?php }else{ ?>
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_1" id="acc_dr_1" value="<?php echo @$row->acc_dr;?>" class="get_coaacno mytextbox"></td>
		<td align="center"><input type="text"  name="name_dr_1" id="name_dr_1" value="<?php echo @$row->acc_name;?>" class="auto-j_name mytextbox"></td>
		<td align="right"><input type="text"   name="acc_debet_1" id="acc_debet_1" class="mytextbox getdeb_value" value="0" style="text-align:right"></td>
		<td align="right"><input type="text"   name="acc_credit_1" id="acc_credit_1" class="mytextbox getcred_value"  value="<?=@number_format(replace_numeric($kredit));?>" style="text-align:right"></td>
	</tr>
	<?php } ?>
	...
	<tr height="25px">
		...
		<td align="right"><input type="text"   name="acc_debet_2" id="acc_debet_2" class="mytextbox getdeb_value" value="<?=@number_format(replace_numeric($kredit));?>"  style="text-align:right"></td>
		<td align="center"><input type="text"  name="acc_credit_2" id="acc_credit_2" class="mytextbox getcred_value" value="0"  style="text-align:right"></td>
	</tr>
	...
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_2" id="acc_dr_2"  class="get_debcoaacno mytextbox"  value="<?=@$row1->acc_no;?>"></td>
		<td align="center"><input type="text"  name="name_dr_2" id="name_dr_2"  class="auto-d_name mytextbox" value="<?=@$row1->acc_name;?>"></td>
		<td align="right"><input type="text"   name="acc_debet_2" id="acc_debet_2" class="mytextbox getdeb_value" value="<?=@number_format($i);?>"  style="text-align:right"></td>
		<td align="center"><input type="text"  name="acc_credit_2" id="acc_credit_2" class="mytextbox getcred_value" value="0"  style="text-align:right"></td>
	</tr>
	<?php } ?>
	...
	<?php if($ppn!=0){ ?>
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_3" id="acc_dr_3"  class="mytextbox get_accdr3" value="<?=$ppni->acc_no;?>"></td>
		<td align="center"><input type="text"  name="name_dr_3"  id="name_dr_3"  class="mytextbox" value="<?=$ppni->acc_name;?>"></td>
		<td align="right"><input type="text"   name="acc_debet_3"  id="acc_debet_3" class="mytextbox getdeb_value"   value="<?=@number_format($h);?>"  style="text-align:right"></td>
		<td align="center"><input type="text"  name="acc_credit_3"  id="acc_credit_3" class="mytextbox getcred_value"  value="0"  style="text-align:right"></td>
	</tr>
	<?php } else { ?>
	...
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_4" id="acc_dr_4"  class="mytextbox get_accdr4"  value="<?=@$pph[0]->acc_no;?>"></td>
		<td align="center"><input type="text"  name="name_dr_4" id="name_dr_4"  class="mytextbox"  value="<?=@$pph[0]->acc_name;?>"></td>
		<td align="right"><input type="text"   name="acc_debet_4" id="acc_debet_4" class="mytextbox getdeb_value"    value="0"  style="text-align:right"></td>
		<td align="center"><input type="text"  name="acc_credit_4" id="acc_credit_4" class="mytextbox getcred_value"   value="<?=@number_format($persen_pph);?>"  style="text-align:right"></td>
	</tr>
	<?php } else { ?>
