...
function generateGrid(gridData,moduleURL,width,height){
	return $('#mytable').jqGrid(gridData)
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 popupForm("<?=site_url()?>"  + 'ap/genpph/generate/?width='+300+'&height='+150);
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 ...
			 popupForm(moduleURL + '/tam/?width='+1080+'&height='+550);
			// myWindow=window.open("<?=site_url()?>" + '/apinvoice-input/' , '_parent' , '/?width='+750+'&height='+700);
		   }, 
		   position:"last"
		})
...
<!--table >
		<tr>
			...
			<td style="background-color:#FF80FF;width:130px;height:25px" >CASH PLANNING</td>
