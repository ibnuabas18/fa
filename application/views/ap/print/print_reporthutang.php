<?php
		...
		//die('a');
			...
			$oo = $this->db->query("sp_kartuhutang '".$project."','".$vendor."','".inggris_date($startdate)."','".inggris_date($enddate)."'");
			$dd = $oo->result();
			...
			#Header
				...
				$pdf->SetXY(25,22);
				$pdf->Cell(0,10,'Periode : '.$startdate.' s/d '.$enddate,20,0,'L');
