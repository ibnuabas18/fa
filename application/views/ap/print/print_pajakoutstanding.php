<?php
		...
		//die('a');
			...
			$oo = $this->db->query("sp_pajakoutstanding '".inggris_date($startdate)."','".inggris_date($enddate)."'");
			$dd = $oo->result();
			...
			$pdf->Cell(30,5,$row->due_date,1,0,'C',0);
			$pdf->MultiCell(130,5,$row->descs);
			...
			$pdf->MultiCell(130,5,$cb->descs,1,'L');
