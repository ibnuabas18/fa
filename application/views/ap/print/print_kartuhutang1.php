<?php
		...
		//(trx_amt*10)/100 as PPN, (trx_amt*10)/100 as PPH23
			...
			$data = $this->db->query("select a.doc_no,a.doc_date,b.nm_supplier,a.inv_no,a.inv_date,a.due_date,a.descs,a.base_amt
									from db_apinvoice a 
			...
			#Header
				...
				$pdf->SetXY(25,22);
				$pdf->Cell(0,10,$periode.' : '.$assoff,20,0,'L');
	...
	$a = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa4";
			...
			$pdf->Cell(25,10,indo_date($row->doc_date),1,0,'C',0);
			$pdf->Cell(45,10,$row->nm_supplier,1,0,'L',0);
			$pdf->Cell(20,10,$row->inv_no,1,0,'C',0);
