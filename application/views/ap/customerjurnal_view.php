...
$(function(){
	...
	$(".get_accdr3").autocomplete({
		source: function(request, response) { 
				$.ajax({ url: "<?php echo site_url();?>autocomplete/get_autocomplete_coaacno",
				data: { term: $(".get_accdr3").val()},
				dataType: "json",
				type: "POST",
				success: function(data){
					response(data);
	...
	$(".get_accdr4").autocomplete({
		source: function(request, response) { 
				$.ajax({ url: "<?php echo site_url();?>autocomplete/get_autocomplete_coaacno",
				data: { term: $(".get_accdr4").val()},
				dataType: "json",
				type: "POST",
				success: function(data){
					response(data);
...
<?php 
	...
	$sql = "select db_kelusaha.acc_dr, db_coa.acc_name from 
				...
				where  db_coa.id_pt = $pt";//var_dump($sql);
...
<table class="datatable">
	...
	?>
	<tr height="25px">
		<td align="center"><input type="text" name="item[acc_dr][0]" id="acc_dr_1" value="<?php echo $row->acc_dr;?>" class="get_coaacno mytextbox"></td>
		<td align="center"><input type="text" name="item[acc_name][0]" id="name_dr_1" value="<?php echo $row->acc_name;?>" class="auto-j_name mytextbox"></td>
		<td align="right"><input type="text" name="item[acc_debet][0]" id="acc_debet_1" class="mytextbox getdeb_value" value="0" style="text-align:right"></td>
		<td align="right"><input type="text" name="item[acc_credit][0]" id="acc_credit_1" class="mytextbox getcred_value"  value="<?=@number_format($d);?>" style="text-align:right"></td>
	</tr>
	<?php }else{ ?>
	<tr height="25px">
		<td align="center"><input type="text" name="item[acc_dr][0]" id="acc_dr_1" value="<?php echo $row->acc_dr;?>" class="get_coaacno mytextbox"></td>
		<td align="center"><input type="text" name="item[acc_name][0]" id="name_dr_1" value="<?php echo $row->acc_name;?>" class="auto-j_name mytextbox"></td>
		<td align="right"><input type="text" name="item[acc_debet][0]" id="acc_debet_1" class="mytextbox getdeb_value" value="0" style="text-align:right"></td>
		<td align="right"><input type="text" name="item[acc_credit][0]" id="acc_credit_1" class="mytextbox getcred_value"  value="<?=@number_format(replace_numeric($kredit));?>" style="text-align:right"></td>
	</tr>
	<?php } ?>
	
	<!-- PPN uncheck and PPH checked -->
	<?php if($ppn==0 and $pph==0){?> 
	<tr height="25px">
		<td align="center"><input type="text" name="item[acc_dr][1]" id="acc_dr_2"  class="get_debcoaacno mytextbox"  value="<?=@$row1->acc_no;?>"></td>
		<td align="center"><input type="text" name="item[acc_name][1]" id="name_dr_2"  class="auto-d_name mytextbox" value="<?=@$row1->acc_name;?>"></td>
		<td align="right"><input type="text" name="item[acc_debet][1]" id="acc_debet_2" class="mytextbox getdeb_value" value="<?=@number_format(replace_numeric($kredit));?>"  style="text-align:right"></td>
		<td align="center"><input type="text" name="item[acc_credit][1]" id="acc_credit_2" class="mytextbox getcred_value" value="0"  style="text-align:right"></td>
	</tr>
	...
	<tr height="25px">
		<td align="center"><input type="text" name="item[acc_dr][1]" id="acc_dr_2"  class="get_debcoaacno mytextbox"  value="<?=@$row1->acc_no;?>"></td>
		<td align="center"><input type="text" name="item[acc_name][1]" id="name_dr_2"  class="auto-d_name mytextbox" value="<?=@$row1->acc_name;?>"></td>
		<td align="right"><input type="text" name="item[acc_debet][1]" id="acc_debet_2" class="mytextbox getdeb_value" value="<?=@number_format($i);?>"  style="text-align:right"></td>
		<td align="center"><input type="text" name="item[acc_credit][1]" id="acc_credit_2" class="mytextbox getcred_value" value="0"  style="text-align:right"></td>
	</tr>
	<?php } ?>
	...
	<?php if($ppn!=0){ ?>
	<tr height="25px">
		<td align="center"><input type="text" name="item[acc_dr][2]" id="acc_dr_3"  class="mytextbox get_accdr3" value="<?=$ppni->acc_no;?>"></td>
		<td align="center"><input type="text" name="item[acc_name][2]"  id="name_dr_3"  class="mytextbox" value="<?=$ppni->acc_name;?>"></td>
		<td align="right"><input type="text" name="item[acc_debet][2]"  id="acc_debet_3" class="mytextbox getdeb_value"   value="<?=@number_format($h);?>"  style="text-align:right"></td>
		<td align="center"><input type="text" name="item[acc_credit][2]"  id="acc_credit_3" class="mytextbox getcred_value"  value="0"  style="text-align:right"></td>
	</tr>
	<?php } else { ?>
	...
	<!-- PPH Checked -->
	<?php if($pph!=0){  $persen_pph = $j; ?>
	<tr height="25px">
		<td align="center"><input type="text" name="item[acc_dr][3]" id="acc_dr_4"  class="mytextbox get_accdr4"  value="<?=@$pph[0]->acc_no;?>"></td>
		<td align="center"><input type="text" name="item[acc_name][3]" id="name_dr_4"  class="mytextbox"  value="<?=@$pph[0]->acc_name;?>"></td>
		<td align="right"><input type="text" name="item[acc_debet][3]" id="acc_debet_4" class="mytextbox getdeb_value"    value="0"  style="text-align:right"></td>
		<td align="center"><input type="text" name="item[acc_credit][3]" id="acc_credit_4" class="mytextbox getcred_value"   value="<?=@number_format($persen_pph);?>"  style="text-align:right"></td>
	</tr>
	<?php } else { ?>
	...
	<!-- update danu -->
	<!--tr height="25px">
		<td align="center"><input type="text" name="item[acc_dr][]" id="acc_dr" class="get_addcoaacno mytextbox"></td>
		<td align="center"><input type="text" name="item[acc_name][]" id="acc_name" class="auto-add_name mytextbox"></td>
		<td align="right"><input type="text" name="item[acc_debet][]" id="acc_debet" style="text-align:right" class="mytextbox calculate"></td>
		<td align="center"><input type="text" name="item[acc_credit][]" id="acc_credit" style="text-align:right" class="mytextbox calculate"></td>
	</tr-->
...
<script type="text/javascript"> 
	...
	$("tbody#itemlist").on("click","#hapus",function(){
		...
		$("#total_debet").val(total_debval);
		$("#total_credit").val(total_credval);
	});
		...
		if(e.keyCode==13){
			...
			items += "<td align='right'><input type='text' name='item[acc_debet][]'   style='text-align:right' id='item[acc_debet][]'   class='detail_nilai mytextbox getdeb_value' value='"+ acc_debet +"'    width='' ></td>";
			items += "<td align='center'><input type='text' name='item[acc_credit][]' style='text-align:right' id='item[acc_credit][]' 	class='detail_nilai mytextbox getcred_value' value='"+ acc_credit +"' width=''></td>";
