...
<h2><font color='red' size='4'>List Kartu Hutang<hr width="150px" align="left"></font></h2>
...
<form method="post" action="<?=base_url()?>ap/kartuhutang_call/kartuhutang" target="_blank">
<table>
	<tr>
	<td>Project</td>
	<td>
		...
		<option></option>
				<?php
					foreach ($project_detail as $row) {
						echo "<option value=".$row->subproject_id." > ".$row->nm_subproject." </option>";
					}
				?>
