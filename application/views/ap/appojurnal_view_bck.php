...
<table class="datatable">
	...
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_1" id="acc_dr_1" value="<?php echo $ap_coa;?>" class="get_addcoaacno1 mytextbox"></td>
		<td align="center"><input type="text"  name="name_dr_1" id="name_dr_1" value="<?php echo $ap_name;?>" class="auto-add_name1 mytextbox"></td>
	...
	if($ppn==0 and $pph==0){?> 
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_2" id="acc_dr_2"  class="get_addcoaacno2 mytextbox"  value="<?=@$row1->acc_no;?>"></td>
		<td align="center"><input type="text"  name="name_dr_2" id="name_dr_2"  class="auto-add_name2 mytextbox" value="<?=@$row1->acc_name;?>"></td>
	...
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_<?php echo $nm;?>" id="acc_dr_<?php echo $nm;?>"  class="mytextbox get_addcoaacno<?php echo $nm;?>"  value="<?php echo $row->acc_no;?>"></td>
		<td align="center"><input type="text"  name="name_dr_<?php echo $nm;?>" id="name_dr_<?php echo $nm;?>"  class="mytextbox auto-add_name<?php echo $nm;?>"  value="<?php echo $row->acc_name;?>"></td>
		<td align="right"><input type="text"   name="acc_debet_<?php echo $nm;?>" id="acc_debet_<?php echo $nm;?>" class="mytextbox"    value="<?php if($ppn!=0){ $kr = replace_numeric($kredit)-(int)$h; echo number_format((int)replace_numeric($kr)*(int)$row->alokasi_persen/100); }else{ echo number_format((int)replace_numeric($kredit)*(int)$row->alokasi_persen/100); }?>"  style="text-align:right"></td>
		<td align="center"><input type="text"  name="acc_credit_<?php echo $nm;?>" id="acc_credit_<?php echo $nm;?>" class="mytextbox"   value="0"  style="text-align:right"></td>
	</tr>
	...
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_3" id="acc_dr_3"  class="mytextbox get_addcoaacno3" value="<?=$ppni->acc_no;?>"></td>
		<td align="center"><input type="text"  name="name_dr_3"  id="name_dr_3"  class="mytextbox auto-add_name3" value="<?=$ppni->acc_name;?>"></td>
	...
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_4" id="acc_dr_4"  class="mytextbox get_addcoaacno4"  value="<?=@$pph[0]->acc_no;?>"></td>
		<td align="center"><input type="text"  name="name_dr_4" id="name_dr_4"  class="mytextbox auto-add_name4"  value="<?=@$pph[0]->acc_name;?>"></td>
	...
	<?php } ?>
	<input type="hidden" name="nm" value="<?php echo $nm-1;?>">
	<!-- Allocation -->
