<?php
		...
		//die("a");
			...
			$pdf->Cell(4,5,':',10,0,'L');
			$pdf->Cell(55,5,number_format($nilai),1,0,'L');
			$pdf->Ln(6);
			
			$t = number_format($nilai);
			
			$pdf->SetX(10);
			$pdf->SetFont('Arial','',8);
			$pdf->Cell(20,5,'Says',10,0,'L');
			$pdf->Cell(4,5,':',10,0,'L');
			$pdf->Cell(158,12,ucwords(toRupiah(($nilai)/1)).' Rupiah',1,0,'L');
			$pdf->Ln(13);
			...
			//for($i = 1;$i <= 27; $i++){
        			...
        			$pdf->SetX(10);
        			$pdf->Cell(8,5,'1',1,0,'C',0);
        			$pdf->Cell(26,5,$data->acc_no,1,0,'L',0);
        			$pdf->Cell(78,5,$data->acc_name,1,0,'L',0);
        			$pdf->Cell(35,5,number_format($nilai),1,0,'R',0);
        			$pdf->Cell(35,5,'0',1,0,'R',0);
        			$pdf->Ln(5);	
					
					$pdf->SetX(10);
        			$pdf->Cell(8,5,'2',1,0,'C',0);
        			$pdf->Cell(26,5,$data->bank_coa,1,0,'L',0);
        			$pdf->Cell(78,5,$data->bank_nm,1,0,'L',0);
        			$pdf->Cell(35,5,'0',1,0,'R',0);
        			$pdf->Cell(35,5,number_format($nilai),1,0,'R',0);
        			$pdf->Ln(5);
