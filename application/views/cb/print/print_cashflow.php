<?php
			...
			#HEADER CONTENT
				...
				$judul 		= "Cashflow Statement";
				$periode	= "ACTUAL AGUSTUS 2012 dan BUDGET";
			...
			#Header
				...
				$pdf->SetXY(25,26);
				$pdf->Cell(0,10,'Amount in Rp',20,0,'L');
				$pdf->Ln(10);
			...
			$pdf->Cell(15,10,'Description',10,0,'C',0);
			$pdf->Cell(20,10,'Budget YTD',10,0,'C',0);
			$pdf->Cell(108,10,'Actual YTD',10,0,'C',0);
			$pdf->Cell(60,5,'Variance',10,0,'C',0);
			$pdf->Ln(5);
