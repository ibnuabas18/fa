<?php
		...
		#1
			...
			$pdf->Cell(20,7,'Account',1,0,'C');
			$pdf->Cell(50,7,'Description',1,0,'C');
			$pdf->Cell(19,7,'Petty Cash',1,0,'C');
			$pdf->Cell(19,7,'MDRCOLL',1,0,'C');
			$pdf->Cell(19,7,'MDRDEV',1,0,'C');
			$pdf->Cell(19,7,'MDRLOAD',1,0,'C');
			$pdf->Cell(19,7,'MDRMDCL',1,0,'C');
			$pdf->Cell(19,7,'MDROPR2',1,0,'C');
			$pdf->Cell(19,7,'MDRPERT',1,0,'C');
			$pdf->Cell(19,7,'MDRPKPU',1,0,'C');
			$pdf->Cell(19,7,'MDRTRNS',1,0,'C');
			$pdf->Cell(19,7,'PERMATA',1,0,'C');
			$pdf->Cell(19,7,'Total',1,0,'C');
			
			$pdf->Ln(7);
		#2
			
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(20,5,'A',1,0,'L');
			$pdf->Cell(50,5,'CASH INFLOW OPERATING',1,0,'L');
			$pdf->SetFont('Arial','',7);
			$pdf->Cell(19,5,'',1,0,'L');
			$pdf->Cell(19,5,'',1,0,'L');
			$pdf->Cell(19,5,'',1,0,'L');
	...
	//	for ($i = 0;$i < 2;$i++){
			...
			$aQ = "select kodecash,nama,kodeperk from cashflow where  LEFT(kodecash,1)='A' and judul='Y'";
		
			$A = $this->db->query($aQ)->result();
		
			foreach ($A as $Ad){
			$pdf->SetFont('Arial','',7);
			$pdf->Cell(20,3,$Ad->kodecash,1,0,'L');
			$pdf->Cell(5,3,'','T'.'B',0,'L');
			$pdf->Cell(45,3,$Ad->nama,'T'.'B',0,'L');
			$pdf->Cell(19,3,number_format($townhouse->amount),1,0,'R');
			$pdf->Cell(19,3,number_format($townhouse->amount),1,0,'R');
			$pdf->Cell(19,3,number_format($townhouse->amount),1,0,'R');
			$pdf->Cell(19,3,number_format($townhouse->amount),1,0,'R');
			$pdf->Cell(19,3,number_format($townhouse->amount),1,0,'R');
			...
			$pdf->Cell(50,3,'Collection Condotel',1,0,'L');
			$pdf->SetFont('Arial','',7);
		...
		#4	
			...
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'Total Cash Inflow Operating',1,0,'L');
			$pdf->SetFont('Arial','',7);
			$pdf->SetLink($link); 
			...
			$pdf->Ln(5);
				$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,5,'B. CASH OUTFLOW OPERATING',1,0,'L');
			$pdf->SetFont('Arial','',7);
			$pdf->Cell(30,5,'',1,0,'L');
		...
		#4
			...
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'Total Cash Outflow Operating',1,0,'L');
			$pdf->SetFont('Arial','',7);
		...
		#5	
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'NET  OPERATING CASH FLOW',1,0,'L',1);
			$pdf->SetFont('Arial','',7);
			...
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,5,'C. CASH INFLOW NON OPERATING',1,0,'L');
			$pdf->SetFont('Arial','',7);
			$pdf->Cell(30,5,'',1,0,'L');
		...
		$other_outflow2 = $this->db->query($other_outflow)->row();
			...
			$pdf->SetFont('Arial','',7);
			$pdf->Cell(50,3,'Interest Of TD, Jasa Giro',1,0,'L');
			$pdf->Cell(30,3,number_format($jasa_giro2->amount),1,0,'R');
			
			$pdf->Ln(3);
			$pdf->Cell(50,3,'Time Deposit Break',1,0,'L');
			$pdf->Cell(30,3,number_format($deposit_break2->amount),1,0,'R');
			
			$pdf->Ln(3);
			$pdf->Cell(50,3,'KPA Break',1,0,'L');
			$pdf->Cell(30,3,number_format($kpa2->amount),1,0,'R');
			
			$pdf->Ln(3);
			// $pdf->Cell(50,3,'BSU',1,0,'L');
			// $pdf->Cell(30,3,'',1,0,'R');
			// $pdf->Cell(30,3,'',1,0,'C');
			// $pdf->Ln(3);
			// $pdf->Cell(50,3,'BDM',1,0,'L');
			// $pdf->Cell(30,3,'',1,0,'R');
			// $pdf->Cell(30,3,'',1,0,'C');
			// $pdf->Ln(3);
			$pdf->Cell(50,3,'Others',1,0,'L');
		...
		#4
			...
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'Total Cash Inflow non Operating',1,0,'L');
			$pdf->SetFont('Arial','',7);
			...
			$pdf->Ln(5);
				$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,5,'D. CASH OUTFLOW NON OPERATING',1,0,'L');
			$pdf->SetFont('Arial','',7);
			$pdf->Cell(30,5,'',1,0,'L');
		...
		$other_out_nonoperating2 = $this->db->query($other_out_nonoperating)->row();
			...
			$pdf->SetFont('Arial','',7);
			$pdf->Cell(50,3,'Bank Charges/Provisi',1,0,'L');
			$pdf->Cell(30,3,number_format($provisi2->amount),1,0,'R');
			
			$pdf->Ln(3);
			$pdf->Cell(50,3,'Time Deposit Placement',1,0,'L');
			$pdf->Cell(30,3,number_format($deposit_kpa2->amount),1,0,'R');
			
			$pdf->Ln(3);
			$pdf->Cell(50,3,'Bank KPA Placement',1,0,'L');
			...
			$pdf->Ln(3);
			$pdf->Cell(50,3,'Cancelation Unit',1,0,'L');
		...
		#4	
			...
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'Total Cash Outflow non Operating',1,0,'L');
			$pdf->SetFont('Arial','',7);
		...
		#5	
			...
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'NET  NON OPERATING CASH FLOW',1,0,'L',1);
			$pdf->SetFont('Arial','',7);
			...
			$pdf->Ln(5);
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'E. NET CASH FLOW',1,0,'L',1);
			$pdf->SetFont('Arial','',7);
			...
			$pdf->Ln(5);
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'F. BEGINNING BALANCE',1,0,'L',1);
			$pdf->SetFont('Arial','',7);
			...
			$pdf->Ln(5);
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(50,4,'G. ENDING BALANCE',1,0,'L',1);
			$pdf->SetFont('Arial','',7);
