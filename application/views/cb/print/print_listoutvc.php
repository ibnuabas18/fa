<?php
			...
			$data = $this->db->query("sp_OutVoucher '".inggris_date($tgl)."','".$project_detail."','".$bank."'")
							 ->result();
	...
	$a = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa4";
			...
			$pdf->Cell(40,10,substr($row->nm_supplier,0,27),1,0,'L',0);
			...
			$pdf->SetX(26);					
			$pdf->Cell(40,5,substr($row->nm_supplier,27),'L'.'R'.'B',0,'L',0);
