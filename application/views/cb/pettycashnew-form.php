...
<form id="formAdd" action="<?php echo base_url();?>pettycashnew/updatedata/<?=@$data->id_ptcash?>" method="post">
	<br>
	<table>
		<tr>
			<h2>FORM ADD</h2>
		...
		<tr>
			<td>Date</td>
			<td> : </td>
			<td><input type="text" id="tgl" name="tgl" style="width:205px;padding:3px;border:1px solid #cbcbcb" value="<?=@$data->tanggal;?>"/></td>
		</tr>
		<tr>
			<td>Project</td>
			<td> : </td>
			<?php $pronow= $this->db->query("select * from db_subproject where subproject_id = ".$data->project_no." ")->row(); ?>
			...
			<td><select name="project" style="width:205px;padding:3px;border:1px solid #cbcbcb">
					<option value="<?=@$data->project_no;?>"><?php echo $pronow->nm_subproject; ?></option>
		...
		<tr>
			<td>Account</td>
			<td> : </td>
			<td><input type="text" name="kode" style="width:205px;padding:3px;border:1px solid #cbcbcb" class="get_coaacno" value="<?=@$data->kode_cashflow;?>" required/></td>
			<td>Amount</td>
			<td> : </td>
			<td><input type="text" name="amt" id="amt" style="text-align:right;width:205px;padding:3px;border:1px solid #cbcbcb" class="calculate" value="<?=number_format(@$data->amount);?>" required/></td>
		</tr>
		<tr>
			<td>Sisa Saldo</td>
			<td> : </td>
		...
		<tr>
			<td>Description</td>
			<td> : </td>
			<td><textarea name="desc" style="width:205px;padding:3px;border:1px solid #cbcbcb" required><?=@$data->deskripsi?></textarea></td>
		</tr>
		<tr>
