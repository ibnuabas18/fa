...
<h2><font color='red' size='4'>AP Payment <hr width="150px" align="left"></font></h2>
<form method="post" action="<?=base_url()?>cb/cetakpayap_call/cetakmutasi" target="_blank">
<table>
	<tr id="vendor">
		<td>Vendor Nm.</td>
	...
	<select name="bank" id="bank">
		...
		<?php 
		$bank = $this->db->query("select * from db_bank where id_pt = '11'")->result();
		foreach($bank as $row){?>
