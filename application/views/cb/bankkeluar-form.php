...
<form id="formAdd" method="post" action="<?=site_url('cb/bankkeluar/Editheader2/'.$data->id_cash.'')?>">
<body>
	<table>
	<tr>
	<td colspan="6">
	...
	<tr>		
			<td>No. Cek</td>
			<td>:</td>
			<td><input type="text" name="nocek" id="nocek" class="validate[required] xinput" xinput" value="<?=@$data->slipno?>" size="26" /></td>
			<td>Bank Date</td>
			<td>:</td>			
