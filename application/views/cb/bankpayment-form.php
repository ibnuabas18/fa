...
<form id="formAdd" method="post" action="<?=site_url('cb/bankpayment/approve_nonap/'.$data->id_cash.'')?>">
<body>
	...
	<tr>	
			...
			<td>Amount</td>			
			<td>:</td>
			<td><input type="text" class="calculate input validate[required]" name="amount" id="amount"  value="<?=number_format(@$data->amount)?>"  style="width:100px;background-color:#EFFC94" readonly="true" size="30" /></td>
	</tr>
	<tr>
	<td>Penerima</td>
			<td>:</td>
