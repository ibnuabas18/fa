...
<form id="formAdd" method="post" action="<?=site_url('cb/bankkeluar/Editheader/')?>">
...
<body>
	...
	<tr>
		<td>Voucher</td>
			...
			<td>Total</td>
			<td>:</td>
			<td><input type="text" name="total_billing" id="total_billing" class="calculate input validate[required]" value="<?php echo $row->amount;?>" style="width:150px;background-color:#EFFC94" readonly="true" size="30" /></td>
	</tr>
	<tr>
		<td>Trans Date</td>
			<td>:</td>		
	...
	<tr>
			...
			<td>Amount</td>			
			<td>:</td>
			<td><input type="text" class="calculate input validate[required]" name="amount" id="amount" value="<?php echo $row->amount?>"  style="width:150px;background-color:#EFFC94" readonly="true" size="30" /></td>
			
	</tr>
	<tr>
		<td>Remark</td>
			<td>:</td>
			<td><textarea name="remark" id="remark" class="validate[required] xinput" style="width:177px;background-color:#EFFC94" readonly="true"  size="30"><?php echo $row->descs?></textarea></td>
		<td>No Arsip</td>
			<td>:</td>
