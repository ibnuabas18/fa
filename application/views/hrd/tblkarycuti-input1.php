...
<form method="post" action="<?=base_url()?>tblkarycuti/insert_cuti">
...
<table>
	...
	<tr> 
		...
		<td>:</td>
			<?php $tgl = date("d-m-Y");  ?>
		<td ><input type="text" name="tgl_aju" id="tgl_aju" value="<?=$tgl?>"  style="width:100px" readonly="true"></td>    
		<td >Saldo Cuti</td>
		<td>:</td>
	...
	<tr > 
		<td >Jenis Cuti</td>
		<td>:</td>
		<td ><select name="jns_cuti" id='cb_karycutijns'></select>
			</td>
		<td >Cuti Bersama</td>
		<td>:</td>
	...
	<tr> 
		...
		<td>:</td>
		<td><select name='aju_cuti' id='aju_cuti' value=''  ><option></option>
				<?php for ($i=1;$i<=12;$i++){ ?>
   ...
   <tr > 
		...
		<td>:</td>
		<td colspan='2'>
		<input name="tgl_mulai" style="width:100"type=text readonly=true id="tgl_mulai">
	...
	<tr> 
		...
		<td>:</td>
		<td colspan='2'><input name="tgl_akhir" style="width:100"type=text readonly=true id="tgl_akhir">
   ...
   <tr > 
		<td > Masuk tanggal </td>
		<td>:</td>
		<td colspan='2'><input name="tgl_msk" style="width:100"type=text readonly=true id="tgl_msk">
	...
	<tr > 
		...
		<td>:</td>
		<td colspan='2'><input name="ket" style="width:400"type=text  id="ket"></td>
   </tr>
