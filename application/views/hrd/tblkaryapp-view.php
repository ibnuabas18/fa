...
<table>
	...
	<tr> 
		...
		<td>:</td>
		<td><input id="cuti_aju" value="<?=@$view['aju_cuti']?>" style="width:30"type=text  readonly=true>Hari</td>
	</tr>
   ...
   <tr > 
		...
		<td>:</td>
		<td><input name="" value='<? echo $c; ?>' id='balancedawal' style="width:50"type=text readonly=true >Hari</td>
