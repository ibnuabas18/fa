...
<h2><font color='red' size='4'>Income Statement<hr width="150px" align="left"></font></h2>
<form method="post" action="<?=base_url()?>gl/incomestatement_call/cetak" target="_blank">
<table>
		
	<tr>
		
		<td>Periode   : </td>
		<td><input type="text" name="tgl" id="tgl" class="required" style="width:120px">&nbsp&nbsp&nbsp&nbsp s/d &nbsp&nbsp&nbsp&nbsp</td>
		 
		<td><input type="text" name="tgl2" id="tgl2" class="required" style="width:120px"></td>
