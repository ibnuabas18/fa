<?php
	...
	$a = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa4";
			...
			$pdf->Cell(60,5,'Keterangan',1,0,'L',0);
			$pdf->Cell(20,5,'No. Invoice',1,0,'C',0);
			$pdf->Cell(20,5,'Ttd. Check',1,0,'C',0);
			$pdf->Cell(20,5,'Tgl. Diambil',1,0,'C',0);
