...
<table>
	...
	<tr>
		<td>Journal No.</td>
			<td>:</td>
			<td><input type="text" name="voucher" id="voucher" class="validate[required] xinput" value="<?=@$nogl?>" style="width:110px;background-color:#EFFC94" readonly="true" size="30" /></td>
	</tr>
	<tr>
		<td>Date</td>
			<td>:</td>
			<td>	<input id="voucher_date" name="voucher_date" value="<?=$tgl?>" size="30"></input></td>	
	</tr>
	<tr>
	<td>Project</td>
			<td>:</td>
	...
	<tr>
		<td>Description</td>
			<td>:</td>
			<td><input type="text" name="remark" id="remark"  value="<?=@$data->remark?>"  size="80" /></td>
	</tr>
	<tr>
	<td>
	</td>	
...
<div class="easyui-tabs" style="width:1000px;height:300px;">
	<div title="Add Detail Adjustment" style="padding:10px;">	
		<table id="dg" title="Input Adjustment" style="width:980px;height:250px"
				url="<?=site_url('adjustment/get_dg_input')?>"
		...
		<div id="toolbar">
			<a id="btn" href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newItem()">Add</a>
			<a id="btn2" href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyItem()">Delete</a>
		</div>
	</div>	
</div>	
	<br>
	...
	<tr>
		...
		<div>
			...
			<td colspan='3'></td>
			<td colspan='3'>Total&nbsp;&nbsp;</td>
			<td colspan='3'><input type="text" align="right" name="totald" id="totald"   style="width:150px;background-color:#EFFC94;text-align:right" readonly="true" size="80" /></td>
		</tr>
			&nbsp;&nbsp;&nbsp;
			<tr>
			<td colspan='3'><input type="text" align="right" name="totalc" id="totalc"   style="width:150px;background-color:#EFFC94;text-align:right" readonly="true" size="80" /></td>
		</tr>		
		</div>
