...
$(function(){
	...
	function loadData(type,parentId){
      ...
      $.post('<?=site_url('view_report/report_view/loaddata_leasing')?>',
...
<h2><font color='red' size='4'>Aging AR Collection Report<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=base_url()?>sales/aging_coll_report/aging_coll_leasing" target="_blank">
<table border="0">
	<tr>
		<td>ALL PROJECT </td>
	...
	<td>:</td>
	<td>
	<select name="duapuluh" id="duapuluh">
	 ...
	 <tr>
		<td colspan="3">
			...
			<input type="submit" name="convert" id="convert" value="Convert To Excel"/>
		</td>
	</tr>
</table>
</form>
