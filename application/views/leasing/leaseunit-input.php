...
-->
<form method='post' action='<?=site_url()?>leaseunit/InsertUnitSewa' id='formadd'>
<table border="0" cellpadding="2" cellspacing="2">
	
  
    <!--Customer Profile-->
    <tr>
		<td colspan="3" style=""><font color='#FF0000'><b><u>ENTRY UNIT LEASING</u></b></font></td>
    </tr>
    <tr>
		<td>Project</td>
		<td>:</td>
		<td>
			...
			<td >No Unit</td>
			<td>:</td>
			<td><input  name='nounit' id='nounit' style='width:80' maxlength='10' class='validate[required]' ></td>
		</td>	
	...
	<tr>
		...
		<td><select name='sub' id='sub'style='width:150' ></td>
				...
				<td >Luas Unit</td>
			<td>:</td>
			<td><input  name='luasunit' id='luasunit' style='width:80' maxlength='10' class='validate[required]' ></td>
	...
	<tr>
		...
		<td><input  name='ablearea' id='ablearea' style='background-color:#80FF00;width:80' readonly></td>
			...
			<td>Price/m2</td>
			<td>:</td>
			<td><input type="text" name="harga_meter" id="harga_meter" class="validate[required] calculate" style='width:100;text-align:right' >
