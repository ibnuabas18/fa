...
<p class="t1"><strong><?=$cekdt->kwitansi_no?> </strong></p> 
<!--
...
-->
<p class="t4_2"><?=Ucfirst(toRupiah($cekdt->kwitansi_pay))?>&nbsp;Rupiah</p>
<p class="t5"></p>
<!--
...
-->
<p class="t7_2"><?=$cekdt->kwitansi_remark?>&nbsp;-&nbsp;<?=$cekdt->kwitansi_descs?></p>
...
<p class="t9"></p>
<p class="t10"></p>
<p class="t11"><strong><?=number_format($cekdt->kwitansi_pay)?> </strong></p>
<p class="t12"></p>
<p class="t13"><strong><?=indo_date($cekdt->kwitansi_paydate)?></strong>  </p>
<p class="t12"></p>
