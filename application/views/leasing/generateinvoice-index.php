...
<body>  
	...
	<h2><font color='red' size='4'>Generate Billing<hr width="200px" color='red' align="left"></font></h2>	 
<form action="<?php echo site_url('generateinvoice/view_invoice')?>" method="post" enctype="multipart/form-data" role="form"> 
