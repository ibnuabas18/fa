...
$(function(){
	...
	grid.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 popupForm("<?=site_url($module_url)?>" + '/add/?width='+800+'&height='+420);
		   }, 
		   position:"last"
		})
	.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 ...
			 if(id){
				 popupForm("<?=site_url($module_url)?>" + '/app/' + id + '/?width='+800+'&height='+700);
			 }else{
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 popupForm("<?=site_url($module_url)?>" + '/view/' + id + '/?width='+600+'&height='+150);
			 }else{
				 alert('Pilih baris yang ingin diedit');
			 }
		   }, 
		...
		// .navButtonAdd('#pager',{
		   ...
		   // onClickButton: function(){ 
			 // var id = getSelectedID();
			 // if(id){
				 // popupForm("<?=site_url($module_url)?>" + '/update/' + id + '/?width='+600+'&height='+150);
			 // }else{
				 // alert('Pilih baris yang ingin diedit');
			 // }
		   // }, 
