...
$(function(){
	...
	grid.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 popupForm("<?=site_url($module_url)?>" + '/add/?width='+1000+'&height='+300);
		   }, 
		   position:"last"
		})
	.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 ...
			 if(id){
				 popupForm("<?=site_url($module_url)?>" + '/update/' + id + '/?width='+1000+'&height='+300);
			 }else{
	...
	.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 popupForm("<?=site_url($module_url)?>" + '/app/' + id + '/?width='+1000+'&height='+300);
			 }else{
				 alert('Pilih baris yang ingin diedit');
			 }
		   }, 
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 popupForm("<?=site_url($module_url)?>" + '/view/' + id + '/?width='+1000+'&height='+300);
			 }else{
				 alert('Pilih baris yang ingin diedit');
			 }
		   }, 
...
<table >
		<tr>
			...
			<td style="background-color:#C1FFC1;;width:130px;height:25px">OPEN DATE</td>
			<td style="background-color:#FFD5D5;width:130px;height:25px" >APPROVED</td>
