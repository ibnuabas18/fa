...
-->
<form method='post' action='<?=site_url()?>contractlease/InsertCustomer' id='formadd'>
<div class="easyui-tabs" style="width:1000px;height:300px;">
    ...
    <tr>
		<td>No Contract</td>
			<td>:</td>
			<td><input name='no_contract' id='no_contract' style='width:150;'  class='validate[required]' >	</td>
    ...
    <tr>
		...
		<td>:</td>
		<td>
			<select name='no_loo' id='no_loo' style='width:150;background-color:#80FFFF'></select></select>
		</td>	
		
			<td>Penyewa</td>
			<td>:</td>
			<td><input name='penyewa' id='penyewa' style='width:150;background-color:#80FFFF' readonly>	</td>
	...
	<tr >
		...
		<td >Start Date</td>
			<td>:</td>
			<td><input  name='tglmulai' id='tglmulai'style='width:80;' class='validate[required]' readonly >
			...
			<td >No Unit</td>
			<td>:</td>
			<td><input name='nounit' id='nounit' style='width:100;background-color:#80FFFF;text-align:center;' readonly>	</td>
	</tr>

	<tr>
		
		<td >Target Open Date</td>
			<td>:</td>
			<td><input  name='tglopen' id='tglopen'style='width:80;' class='validate[required]' readonly >
			...
			<td >Luas Unit</td>
			<td>:</td>
			<td><input name='luas' id='luas' style='width:80;background-color:#80FFFF;text-align:center;' readonly>	</td>
	...
	<tr id='tr2'>
		<td>Grace Period</td>
			<td>:</td>
			<td><select  name='period' id='period' style='width:40' class='validate[required]' readonly>
				<?$x=0;while($x<=60){?>
				<option><?=$x;$x++;?></option>
				<?}?></select>Month</td>
			...
			<td>Proyek</td>
			<td>:</td>
			<td><input name='nm_subproject' id='nm_subproject' style='width:150;background-color:#80FFFF' readonly>	</td>
	...
	<tr>
		<td>Sewa Per Meter</td>
			<td>:</td>
			<td><input name='hrg_meter' id='hrg_meter' style='width:150;background-color:#FF80FF;text-align:right' class='validate[required] calculate' ></td>
...
-->
		...
		<table id="dg" title="Payment Plan" style="width:980px;height:250px"
				url="<?=site_url('contractlease/get_dg')?>"toolbar="#toolbar" pagination="true"
