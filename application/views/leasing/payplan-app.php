...
<body>	
	...
	<tr>
		<td>CODE</td>
			<td>:</td>
			<td><input type="text" name="kode" id="kode"  class="validate[required] xinput" xinput"   value="<?=@$data->kode?>"  class="validate[required]" style="width:180px;background-color:#EFFC94" readonly="true" size="30" />
	...
	<tr>
		<td>Description</td>
			<td>:</td>
			<td><input "text " name="remark" id="remark" class="validate[required] xinput" xinput" value="<?=@$data->payplan_nm?>"  size="65" /></td>		
...
<div class="easyui-tabs" style="width:1000px;height:300px;">
	<div title="Term Payment Plan" style="padding:10px;">	
		<table id="dg" title="Payment Plan" style="width:980px;height:250px"
				url="<?=site_url('payplan/get_dg')?>/<?=$data->kode?>"
