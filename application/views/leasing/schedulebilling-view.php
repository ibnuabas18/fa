...
-->
<form method='post' action='<?=site_url()?>schedulebilling/editbilling' id='formadd'>
<table border="0" cellpadding="2" cellspacing="2">
    ...
    <tr>
		...
		<td>:</td>
		<td>
		<input  name='idbill' id='idbill' value="<?=@$data->id_invoice?>" maxlength='10' style='background-color:#FFFF00;width:80' readonly >
