...
$(function(){
	...
	.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			...
			if(celValue==1){
			  window.open("<?=site_url()?>" + '/kwtbillleasing/reprintkwt/'  + id + '/?width='+650+'&height='+400);
			  }  else if (id) {		
				window.open("<?=site_url()?>" + '/kwtbillleasing/reprintkwt/'  + id + '/?width='+650+'&height='+400);
				}
			  else{
	...
	.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			...
			if(celValue==1){
			 popupForm("<?=site_url()?>" + '/kwtbillleasing/reprintkwt/'  + id + '/?width='+650+'&height='+400);
			  }  else if (id) {		
				window.open("<?=site_url()?>" + '/kwtbillleasing/reprintkwt/'  + id + '/?width='+650+'&height='+400);
				}
			  else{
	...
	<? } ?>	
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 window.open("<?=site_url()?>" + '/kwtbillleasing/receipt/' + id + '/?width='+750+'&height='+700);
			 }else{
				 alert('Pilih baris yang ingin diedit');
			 }
		   }, 
