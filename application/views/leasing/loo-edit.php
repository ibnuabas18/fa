...
<table border="0" cellpadding="2" cellspacing="2">
	<? $today = date('d-M-Y');?>
	<input value="<?=@$data->id?>" name="id" id='cek' type="hidden">
	...
	<td >NO LOO</td>
		<td >:</td>
		<td  ><b><input name= id= style='width:150;background-color:#FF8080' readonly value=<?=$data->no_loo?>></b></td>
	...
	<tr>
		...
		<td><select name='tenant' id='tenant' style='width:150' readonly>
			<option><?=$data->customer_nama?></option>
	...
	<tr>
		...
		<td>No.Tlp</td>
		<td>:</td>
		<td><input name='tlp' id='tlp' style='background-color:#FFFF00;width:80' value=<?=$row->customer_hp?> readonly></td>
