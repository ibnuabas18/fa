...
-->
<form method='post' action='<?=site_url()?>generateinvoice/editbilling' id='formadd'>
<table border="0" cellpadding="2" cellspacing="2">
	
  
    <!--Customer Profile-->
    <tr>
		<td colspan="3" style=""><font color='#FF0000'><b><u>Edit Schedule Billing</u></b></font></td>
    </tr>
    <tr>
		<td>ID</td>
		<td>:</td>
		<td>
		<input  name='idbill' id='idbill' value="<?=@$data->id_invoicesum?>" maxlength='10' style='background-color:#FFFF00;width:80' readonly >
		<td>	<input id="kd_tenant" name="kd_tenant"  value="<?=@$data->kd_tenant?>" size="30"></input> 
		</td>			
    </tr>
	<tr>		
		<td>Billing Date</td>
		<td>:</td>
		<td>	<input id="billdate" name="billdate"  class="easyui-datebox" value="<?=@$data->tgl_invoice?>" size="30"></input> 
		<td>	<input id="tgl" name="tgl"  class="easyui-datebox" value="<?=@$data->tgl_invoice?>" size="30"></input> 		
		</td>
	</tr>
	...
	<tr>
		...
		<td>:</td>
		<td>
		<input type="text" size="60" name="descs" id="descs" value="<?=@$data->description?>" class="xinput validate[required]"class="xinput">
		</td>
	</tr>
