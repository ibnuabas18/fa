...
-->
<form method='post' action='<?=site_url()?>contractlease/renewalkontrak' id='formadd'>
<div class="easyui-tabs" style="width:1000px;height:300px;">
    ...
    <tr>
		...
		<td>:</td>
		<td>
			<input name='no_loo' id='no_loo'  value="<?=@$data->no_loo?>" style='width:150;background-color:#80FFFF'  class='validate[required]' >	
			...
			<td>Penyewa</td>
			<td>:</td>
			<td><input name='penyewa' id='penyewa' value="<?=@$data->customer_nama?>" style='width:250;background-color:#80FFFF' readonly>	</td>		
    </tr>    
	<tr >		
		<td >Start Date</td>
			<td>:</td>
			...
			<td >No Unit</td>
			<td>:</td>
			<td><input name='nounit' id='nounit' value="<?=@$data->nounit?>"  style='width:100;background-color:#80FFFF;text-align:left;' readonly>	</td>
	</tr>
	...
	<tr>
		...
		<td >End Date</td>
			<td>:</td>
			<td><input  name='tglselesai' id='tglselesai'style='width:80;' value="<?=@$data->tgl_selesai?>" class='validate[required]' readonly >
				<a href="JavaScript:;" onClick="return showCalendar('tglselesai', 'dd-mm-y');" title="Pilih Tanggal" > <img src="<?=base_url()?>assets/js/ico_calendar.gif" alt="s"/></a>
			</td>
				
			<td >Luas Unit</td>
			<td>:</td>
			<td><input name='luas' id='luas' value="<?=@$data->luas?>" style='width:80;background-color:#80FFFF;text-align:left;' readonly>	</td>
	...
	<tr>
		<td>Interval</td>
			<td>:</td>
			<td><input name='interval' id='interval' class='validate[required]' style='width:150;text-align:right' ></td>
	...
	<tr id='tr14'>
		<td colspan="3">
			<input type="submit" name="save" value="Renewal"/>
