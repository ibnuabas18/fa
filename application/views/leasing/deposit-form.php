...
<table>
	...
	<tr>
		<td>Nomor</td>
			<td>:</td>
			<td><input type="text" name="no_deposit" class="validate[required] xinput" id="no_deposit" value="<?=@$data->no_deposit?>"  size="30" /></td>
	</tr>
	<tr>	
			<td>Project</td>
			<td>:</td>
			<td>
			<select name='subproject' id='subproject' value="<?=@$data->id_subproject?>" style='width:150;background-color:#80FFFF'></select></select>		
			</td>
	</tr>
	<tr>
		<td>Date</td>
			<td>:</td>
			<td><input id="date" name="date" value="<?=@$data->date?>" class="easyui-datebox" size="30"></input></td>
	</tr>
	<tr>	
			<td>Tenant</td>
			<td>:</td>
			<td>
			<select name='kd_tenant' id='kd_tenant' value="<?=@$data->kd_tenant?>" style='width:150;background-color:#80FFFF'></select></select>		
			</td>
	</tr>
	<!--<tr>
		<td>Cash Out</td>
