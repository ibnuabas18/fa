...
<h2><font color='red' size='4'>Cash Flow Report <hr width="150px" align="left"></font></h2>
<form method="post" action="<?=base_url()?>cb/printcashflow_call/cetakcashflow" target="_blank">
<table>
