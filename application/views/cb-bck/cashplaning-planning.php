...
<form method="post" action="<?=site_url('cashplaning/saveplan')?>">
 <?php $tgl = date('m/d/Y'); ?>
<body>
	<table>
	<tr>
	...
	<tr>
		<td>Amount Plan</td>
			<td>:</td>
			<td><input type="text" name="amount" id="amount" class="calculate input validate[required]"  value="<?=$row->trx_amt?>" size="30" /></td>
		<tr>
		<tr>
		<!--<td>ID</td>
			<td>:</td>-->
