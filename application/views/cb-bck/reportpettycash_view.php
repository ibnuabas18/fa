...
<h2><font color='red' size='4'>Reimburs Petty Cash <hr width="150px" align="left"></font></h2>
<form method="post" action="<?=base_url()?>cb/reportpettycash_call/cetakpetty" target="_blank">
<table>
