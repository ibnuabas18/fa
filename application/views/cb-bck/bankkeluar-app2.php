...
// $("#apno").change(function(){
    ...
    // });  
		$(function(){
			$('#dg').edatagrid({
				url: "<?=site_url('bankkeluar/cekdata')?>",
...
<form method="post" action="<?=site_url('bankkeluar/saveheader')?>">
 <?php $tgl = date('m/d/Y'); ?>
<body>
	<table>
	<tr>
	...
	<tr>
		<td>Voucher</td>
			...
			<td>Tagihan AP</td>
			<td>:</td>
			<td><input type="text" name="apno" id="apno" class="validate[required] " value="<?=@$data->doc_no?>" style="width:100px;background-color:#EFFC94" readonly="true" size="30" /></td>
			<!--<td>
                        <select name="apno" id="apno">
						<option></option>
                                                            <? foreach($po as $row): ?>
                                                            <option value="<?=@$row->apinvoice_id?>"><?=@$row->doc_no?></option> 
                                                            <? endforeach;?>
                        </select>          
            </td>-->
	...
	<tr>
		<td>Remark</td>
			<td>:</td>
			<td><input type = "text " name="remark" id="remark" class="validate[required] xinput" xinput" value="<?=@$data->remark?>" class="validate[required]" size="30" /></td>
