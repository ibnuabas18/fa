	...
	return $('#mytable').jqGrid(gridData)
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 ...
			 if(id){
				popupForm(moduleURL + '/mutasi/' + id + '/?width='+800+'&height='+400);	
			 }else{
				alert('Pilih baris yang ingin dimutasi');
			 }
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 popupForm(moduleURL + '/jual/' + id + '/?width='+800+'&height='+400);	
			 }else{
				 alert('Pilih baris yang ingin dijual');
			 }
		   }, 
		   position:"last"
		})
