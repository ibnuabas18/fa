...
<form id="formAdd" method="post" action="<?php echo base_url();?>akunting/cataset/savekat">
	<br>
	<table>
		<tr>
			<h2>FORM ADD</h2>
		...
		<tr>
			<td>Kode Kategori</td>
			<td> : </td>
			<td><input type="text" name="kode" style="width:205px;padding:3px;border:1px solid #cbcbcb" required/></td>
		</tr>
		<tr>
			<td>Kategori</td>
			<td> : </td>
			<td><input type="number" name="kategori" style="width:205px;padding:3px;border:1px solid #cbcbcb" required/> tahun</td>
		</tr>
		<tr></tr>
		<tr>
