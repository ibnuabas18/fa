...
<form id="formAdd" method="post" action="<?php echo base_url();?>akunting/locaset/saveloc">
	<br>
	<table>
		<tr>
			<h2>FORM ADD</h2>
		...
		<tr>
			<td>Kode Lokasi</td>
			<td> : </td>
			<td><input type="text" name="kd_lokasi" style="width:205px;padding:3px;border:1px solid #cbcbcb" required/></td>
		</tr>
		<tr>
			<td>Lokasi</td>
			<td> : </td>
			<td><input type="text" name="lokasi" style="width:205px;padding:3px;border:1px solid #cbcbcb" required/></td>
		</tr>
		<tr>
			<td>Detail</td>
			<td> : </td>
			<td><textarea name="detail" style="width:205px;padding:3px;border:1px solid #cbcbcb" required></textarea></td>
		</tr>
		<tr></tr>
		<tr>
