...
<h2><font color='red' size='4'>AGING ASSET <hr width="150px" align="left"></font></h2>
<form method="post" action="<?php echo base_url();?>akunting/cetakagingaset_call/cetakaging" target="blank">
<table>
	<tr>
		<td>Aset</td>
		<td> : </td>
