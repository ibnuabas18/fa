		...
		<tr>
			...
			<td colspan='3' valign='center' align='center' bgcolor='black'><font color='white'><b>ALL BUDGET</b></font></td>
				...
				<tr>
						<td>Budget  Month</td>
						<td>:</td>
						<td><input type='text' size="5" value=<?=number_format($totmnth)?> name='totmnth' style='text-align:right;'  readonly></td>					
						<td>Budget  Month</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($totmnthdiv)?> name='totmnthdiv' style='text-align:right;' readonly></td>
						
						<td>Budget  Month</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($totmnthalldiv)?> name='totmnthalldiv' style='text-align:right;' readonly></td>
				</tr>
				<tr>
						<td>Actual  Month</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actmonth)?> name='actmonth' style='text-align:right;' readonly></td>
					
						<td>Actual  Month</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actdivmonth)?> name='actdivmonth' style='text-align:right;' readonly></td>
						
						<td>Actual  Month</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actmnthalldiv)?> name='actmnthalldiv' style='text-align:right;' readonly> </td>
				</tr>
				<tr>
						<td>Balance Budget  Month</td>
						<td>:</td>
						<td align='right'><input type='text' value='<?=number_format($blc_month)?>' name='blc_month' style='text-align:right;' readonly></td>
					
						<td>Balance Budget  Month</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($blc_divmonth)?> name='blc_divmonth' style='text-align:right;' readonly></td>
						
						<td>Balance Budget  Month</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($blc_alldivmonth)?> name='blcalldivmonth' style='text-align:right;' readonly></td>
				</tr>
				<tr>	
						<td>Budget  YTD</td>
						<td>:</td>
						<td align='right'><input value=<?=number_format($totytd)?> name='totytd' style='text-align:right;' readonly></td>
					
						<td>Budget  YTD</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($totytddiv)?> name='totytddiv' style='text-align:right;' readonly></td>
						
						<td>Budget  YTD</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($totytdalldiv)?> name='totytdalldiv' style='text-align:right;' readonly></td>
				</tr>
				<tr>
						<td>Actual  YTD</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actytd)?> name='actytd' style='text-align:right;' readonly> </td>
					
						<td>Actual  YTD</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actytddiv)?> name='actytddiv' style='text-align:right;' readonly></td>
						
						<td>Actual  YTD</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actytdalldiv)?> name='actytdalldiv' style='text-align:right;' readonly></td>
				</tr>
				<tr>
						<td>Balance Budget  YTD</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($blcytd)?> name='blcytd' style='text-align:right;' readonly></td>
					
						<td>Balance Budget  YTD</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($blcytddiv)?> name='blcytddiv' style='text-align:right;' readonly></td>
						
						<td>Balance Budget  YTD</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($blcytdalldiv)?> name='blcytdalldiv' style='text-align:right;' readonly></td>
				</tr>
				<tr>						
						<td>Budget  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($totmst)?> name='totmst' style='text-align:right;' readonly></td>
					
						<td>Budget  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($totdiv)?> name='totdiv' style='text-align:right;' readonly></td>
						
						<td>Budget  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($totalldiv)?> name='totalldiv' style='text-align:right;' readonly></td>
				</tr>
				<tr>						
						<td>Actual  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actann)?> name='actann' style='text-align:right;' readonly></td>
					
						<td>Actual  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actanndiv)?> name='actanndiv' style='text-align:right;' readonly></td>
						
						<td>Actual  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($actannalldiv)?> name='actannalldiv' style='text-align:right;' readonly></td>
				</tr>
				<tr>
						<td>Balance Budget  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($blcann)?> name='blcann' style='text-align:right;' readonly></td>
										
						<td>Balance Budget  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($blcanndiv)?> name='blcanndiv' style='text-align:right;' readonly></td>
					
						<td>Balance Budget  Annual</td>
						<td>:</td>
						<td align='right'><input type='text' value=<?=number_format($blcannalldiv)?> name='blcannalldiv' style='text-align:right;' readonly></td>
				</tr>
			<tr>
