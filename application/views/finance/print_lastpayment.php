<?php
			...
			$data = $this->db->query("sp_lastpayment '".inggris_date($tgl1)."','".inggris_date($tgl2)."'")->result();
			...
			$pdf->Cell(20,5,'Nama Sales',1,0,'C',1);
			$pdf->Cell(20,5,'Sales Date',1,0,'C',1);
			$pdf->Cell(30,5,'Customer Name',1,0,'C',1);
			$pdf->Cell(55,5,'Unit No',1,0,'C',1);
			$pdf->Cell(20,5,'Selling Price',1,0,'C',1);
			$pdf->Cell(20,5,'Payment Date',1,0,'C',1);
			$pdf->Cell(20,5,'Persen',1,0,'C',1);
	...
	$a = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa4";
			...
			$pdf->Cell(20,5,$row->nama,1,0,'C',0);
			$pdf->Cell(20,5,indo_date($row->tgl_sales),1,0,'L',0);
			$pdf->Cell(30,5,$row->customer_nama,1,0,'L',0);
			$pdf->Cell(55,5,$row->unit_no,1,0,'L',0);
			$pdf->Cell(20,5,number_format($row->selling_price),1,0,'R',0);
			$pdf->Cell(20,5,number_format($row->payment),1,0,'R',0);
			$pdf->Cell(20,5,$row->persen,1,0,'R',0);
