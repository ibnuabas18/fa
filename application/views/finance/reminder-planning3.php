...
<form method="post" action="<?=site_url('reminder/surat_reminder3')?>">
 <?php $tgl = date('m/d/Y'); ?>
<body>
	<table>
	<tr>
	...
	<td>Date 2</td>
			<td>:</td>
			<td>
			<input id="tgl2" name="tgl2" class="easyui-datebox" value="<?=$tgl?>" size="30"></input>
			</td>			
	...
	<tr>
		<td>Reminder No 2</td>
			<td>:</td>
			<td><input type="text" name="no_reminder2" id="no_reminder2"  size="30" /></td>
		<tr>
		<tr>
		<!--<td>ID</td>
			<td>:</td>-->
