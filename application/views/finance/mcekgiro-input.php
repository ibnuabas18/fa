...
<link rel="stylesheet" href="<?=base_url()?>assets/css/menuformx.css" type="text/css" />
<form method="post" action="<?=site_url('mcekgiro/cekgiro_view')?>" id="ormAdd" target="_blank">
<h1>Cek/Giro</h1>
<table border="0"  cellpadding="2" cellspacing="2">
	...
	<tr>
		...
		<td>:</td>
		<td>
			<input type="text" name="nm" id="nm" class="validate[required]" value=""/>
		</td>
	</tr>		
	<tr>
	...
	<tr>
		<td>Nomor Cek</td>
		<td>:</td>
		<td><input type="text" maxlength="12" name="no_cek" id="no_cek" class="" value=""/></td>
	</tr>	
	<tr>
	...
	<tr>
		<td>Jumlah</td>
		<td>:</td>
		<td><input type="text"  class="calculate validate[required]" name="jml" id="jml" value=""/></td>
	</tr>				
	<tr>
