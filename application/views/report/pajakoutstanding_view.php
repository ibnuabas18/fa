...
<h2 style="margin:10px">Report Pajak Outstanding<hr width="90px" align="left"></h2>
<div class="printed">
<form action="<?=base_url()?>ap/pajakoutstanding/print_ap" id="formAdd" method="POST" target="_blank">
	<?php
		$tgl = date('d-m-Y');
	?>
