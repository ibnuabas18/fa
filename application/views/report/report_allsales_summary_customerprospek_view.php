...
<h2><font color='red' size='4'>ALL PROSPECT SUMMARY REPORT<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=base_url()?>print/print_allsales_summary_customerprospek" target="_blank">
<table border="0">
