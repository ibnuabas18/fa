...
<h2><font color='red' size='4'>PROSPECT MOD MALL 2 MALL ANALYSIS<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=base_url()?>print/print_mall2mall_customerprospek" target="_blank">
<table border="0">
	<tr>
		<td>Mall 2 Mall</td>
		<td>:</td>
		<td>
			<select name="venue" id="mall" style="width:100px">
