...
<h2><font color='red' size='4'>PROSPECT DETAIL REPORT<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=base_url()?>print/print_sales_customerprospek" target="_blank">
<table border="0">
	<tr>
		<td>Sales Name</td>
		<td>:</td>
