...
<h2><font color='red' size='4'>COMPLAINT CUSTOMER REPORT<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=base_url()?>print/print_detail_customerservice" target="_blank">
<table border="0">
	<tr>
		<td>Customer</td>
		<td>:</td>
		<td>
			<select name="customer" id="customer" style="width:100px">
