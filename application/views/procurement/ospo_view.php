...
<h2><font color='red' size='4'>Outstanding Report PO<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=site_url('procurement/print_ospo/print_ospopdf')?>" target="_blank">
...
<table>
	...
	<tr>
	<input type="hidden" id="pt" name="pt" value="<?=$this->pt ?>">
	<tr id="x_hide">
		<td>Vendor</td>
		<td>:</td>
		<td colspan="4">
