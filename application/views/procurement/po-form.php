...
<div style="width:900px;padding:20px 0 0 0">
	<div class="x1">
		...
		<label>Tgl. Kirim</label><input type="text" name="tgl_kirim" id="tgl_kirim" style="width:120px;height:5px" readonly="true"/><br/>
	</div>
	<div>
