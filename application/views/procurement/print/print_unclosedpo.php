<?php
			...
			$data = $this->db->query("sp_unclosepo '".$div."','".$kat."','".$ven."','".inggris_date($start_date)."','".inggris_date($end_date)."'")
							 ->result();
			...
			$pdf->Cell(45,5,'PO',1,0,'C',1);
			$pdf->Cell(45,5,'MRR',1,0,'C',1);
			$pdf->Cell(30,10,'VENDOR',1,0,'C',1);
			$pdf->Cell(75,10,'Description',1,0,'C',1);
			$pdf->Cell(20,10,'Amount',1,0,'C',1);
			$pdf->Cell(25,10,'Division',1,0,'C',1);
			$pdf->Cell(40,5,'Lead Time',1,0,'C',1);
			...
			$pdf->Cell(20,5,'PR to PO',1,0,'C',1);
			$pdf->Cell(20,5,'PO to MRR',1,0,'C',1);		
	...
	foreach($data as $row){
		...
		if($no == $max){ 
			...
			$pdf->Cell(8,10,'No',1,0,'C',1);
			$pdf->Cell(40,5,'PO',1,0,'C',1);
			$pdf->Cell(40,5,'MRR',1,0,'C',1);
			$pdf->Cell(25,10,'VENDOR',1,0,'C',1);
			$pdf->Cell(35,10,'Description',1,0,'C',1);
			$pdf->Cell(20,10,'Amount',1,0,'C',1);
			$pdf->Cell(20,10,'Division',1,0,'C',1);
			$pdf->Cell(35,5,'Lead Time',1,0,'C',1);
		...
		//
			...
			$pdf->Cell(25,5,$row->no_po,1,0,'L',0);
			$pdf->Cell(20,5,indo_date($row->tgl_mrr),1,0,'L',0);
			$pdf->Cell(25,5,$row->no_mrr,1,0,'L',0);
			$pdf->Cell(30,5,$row->nm_supp,1,0,'L',0);
			$pdf->Cell(75,5,$row->ket_pr,1,0,'L',0);
			$pdf->Cell(20,5,number_format($row->harga_tot),1,0,'R',0);
			$pdf->Cell(25,5,$row->div,1,0,'L',0);
			$pdf->Cell(20,5,$row->d1,1,0,'L',0);
			$pdf->Cell(20,5,$row->d2,1,0,'L',0);
			$pdf->Ln(5);				
			$i++;
			$no++;
			...
			$pdf->Cell(20,5,number_format($tot),1,0,'R',1);
			$pdf->Cell(25,5,'',10,0,'L',0);
			$pdf->Cell(20,5,'',10,0,'L',0);
			$pdf->Cell(20,5,'',10,0,'L',0);
