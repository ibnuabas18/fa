<?php
			...
			$data = $this->db->query("sp_ospogmi '".$div."','".$kat."','".$ven."','".inggris_date($start_date)."','".inggris_date($end_date)."'")
							 ->result();
	...
	foreach($data as $row){
		...
		//
			...
			$pdf->Cell(38,5,$row->no_po,1,0,'L',0);
			...
			$pdf->Cell(60,5,substr($row->ket_pr,0,70),1,0,'L',0);
			//$pdf->Cell(80,5,$row->ket_pr,1,0,'L',0);
			$pdf->Cell(27,5,number_format($row->harga_tot),1,0,'R',0);
			$pdf->Cell(23,5,$row->divisi_nm,1,0,'C',0);
			$pdf->Ln(5);				
			$i++;
			$no++;
			...
			$pdf->Cell(38,5,'',0,0,'L',0);
			$pdf->Cell(20,5,'',0,0,'C',0);
			$pdf->Cell(28,5,'',0,0,'L',0);
			$pdf->Cell(60,5,'',0,0,'L',0);
			$pdf->Cell(60,5,'TOTAL',1,0,'L',0);
			$pdf->Cell(27,5,number_format($tot),1,0,'R',0);
