...
// });	
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = 1;
			 if(id){
				 popupForm(moduleURL + '/generate/' + id + '/?width='+0+'&height='+0);
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				// popupForm(moduleURL + '/reportlisting/' + id + '/?width='+0+'&height='+0);
				 window.open("<?=site_url($module_url)?>" + '/reportlisting/' + id + '/?width='+900+'&height='+500);
				// alert('Posting Berhasil');
				refreshTable();
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 ...
			 if(id){
				// popupForm(moduleURL + '/reportlisting/' + id + '/?width='+0+'&height='+0);
				 window.open("<?=site_url($module_url)?>" + '/reportexcel/' + id + '/?width='+900+'&height='+500);
				// alert('Posting Berhasil');
				refreshTable();
