...
/*validation form*/
	...
	success:function(response){
		if(response == "sukses"){
			...
			setTimeout("location.reload(true);",1500);
			window.open("<?=site_url('spcustomer/surat_pesanan')?>/"+nama+"");/*+"/"
			 ...
			 <tr class="sphide">
				...
				<tr class="sphide">
					...
					<td ><input type="text" name="spno" id="spno" class="xinput validate[required]"  style='width:50px' readonly></td>
						...
						<td>:</td>
						<td colspan='5'><input type="text" name="disc1" id="disc1" class="xinput input" style='width:50px' maxlength='5' ><span class="hide_x">+</span><input type="text" name="disc2" id="disc2" class=" xinput  input" style='width:50px' maxlength='5'>
				...
				<tr class="sphide">
					...
					<td><span id='unitno'></span></td>
						<td>Down Payment</td>
							...
							<td colspan='3' class="hide_z">
								<input name="dpdate"  id="dpdate" class="xinput validate[required] clearall datepicker" style='width:80px' readonly />
								</a>
				...
				<tr>
					...
					<td><font color='red'><span id='unitstatus'></font></td>
							...
							<td colspan='3' class="hide_z">
								<input name="pldate"  id="pldate" class="xinput validate[required] clearall datepicker" style='width:80px' readonly />
								</a>
