...
<script type="text/javascript">
   function loadData(type,parentId){
      ...
      $.post('<?=site_url('sales/unit_status/loaddata')?>', //request ke fungsi load data di inputAP
...
$(function(){
	...
	$('#lunas').change(function(){
			...
			$.post("<?=site_url('sales/unit_status/cekprice')?>",
...
<div id="wrapform">
	<form method="post" action="<?=site_url('sales/sales_admin_status/updatestatus')?>" id="formAdd">
		...
		<table border="0" cellspacing="2" cellpadding="2">
			...
			<tr>
				...
				<td width="6">:</td>
				<td width="25"><input type="text" name="amount" id="amount" style="text-align:right" class="calculate" maxlength="12px"/></td>	
			</tr>
			<tr>
				<td>Semigross Sqm</td>
				<td>:</td>
