...
<script type="text/javascript">
   ...
   function loadData(type,parentId){
      ...
      $.post('<?=site_url('sales/viewunitocea_status/loaddata')?>', //request ke fungsi load data di inputAP
...
<div id="wrapform">
	<form method="post" action="<?=site_url('sales/viewunitocea_status/updatestatus')?>" id="formAdd">
