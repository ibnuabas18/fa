...
<h2><font color='red' size='4'>Historical Sales Payment Report<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=base_url()?>sales/report_sales/history_pembayaran_report" target="_blank">
<table border="0">
	<tr>
		<td>Project</td>
		<td>:</td>
