...
$(function(){
	...
	grid.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 ...
			 if(id){
				 window.open("<?=site_url()?>" + '/listssp/reprintssp/' + id);
			 }else{
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 popupForm("<?=site_url($module_url)?>" + '/view/' + id + '/?width='+800+'&height='+550);
			 }else{
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 popupForm("<?=site_url($module_url)?>" + '/add/?width='+800+'&height='+550);
		   }, 
		   position:"last"
		})
