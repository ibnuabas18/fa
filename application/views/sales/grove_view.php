...
<script type="text/javascript">
   ...
   function loadData(type,parentId){
      ...
      $.post('<?=site_url('sales/viewunitgrove_status/loaddata')?>', //request ke fungsi load data di inputAP
...
<div id="wrapform">
	<form method="post" action="<?=site_url('sales/viewunitgrove_status/updatestatus')?>" id="formAdd">
		...
		<table id="tabel" border="0" cellspacing="2" cellpadding="2" width="750" height="450">
			<tr>
				<td colspan="3" align="center"><img src="https://mis.bsu.co.id/assets/foto/web_jeroan.jpg" height="150" width="120"></td>
			...
			<tr>
				...
				<td class="hide_x"><input type="text" name="custnm" id="custnm" style="width:150px"></td>				
			</tr>			
			<tr>
				<td>Floor</td>
				<td>:</td>
			...
			<tr>
				...
				<td>:</td>
				<td colspan="4">
					<textarea name="ket" width="50" height="40"></textarea>
				</td>				
			</tr>
