...
<script type="text/javascript">
 ...
 function loadData(type,parentId){
      ...
      $.post('<?=site_url('sales/alokasi_status/loaddata')?>', //request ke fungsi load data di inputAP
...
<div style="padding:10 0 0 10">
	<form method="post" action="<?=site_url('sales/alokasi_status/view_alokasi')?>">
	...
	<tr>
		<td>View</td>
			<td>:</td>
				...
				</select><input type="checkbox" id="all">All
