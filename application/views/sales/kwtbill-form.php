...
<form method="post" action="<?=site_url()?>kwtbill/paycancel" id="formadd">
<input type="hidden" name="idkwt" id="idkwt" value="<?=$data->kwtbill_id?>"/>
...
<table border="0">
	...
	<tr>
		<td>Payment Date</td>
		<td>:</td>
		<td><?=indo_date($data->kwtbill_paydate)?></td>
	</tr>	
	<tr>
		<td>No Kwitansi</td>
		<td>:</td>
		<td><?=$data->kwtbill_no?></td>
	</tr>
	<tr>
		<td>Pembayaran</td>
		<td>:</td>
		<td><?=$data->kwtbill_remark?></td>
	</tr>
	<tr>
		<td>Amount</td>
		<td>:</td>
		<td><?=number_format($data->kwtbill_pay)?></td>
	</tr>
	<tr>
		<td>Remark</td>
		<td>:</td>
