...
<div id="wrap">
	...
	<div class="classhome"><a href="<?=site_url('sales/viewunitocea_status')?>" ><< back</a></div>
	<!--<div id="wrapheader">-->
...
<table id="tabel" border="0">	
	...
	<div id="wrapcenter">
		...
		//die($view);
			...
			//$que = $this->db->get('db_unit_ocea')->result();
			//var_dump($que);
			...
			foreach($data['unit'] as $row):
				...
				if($no==$max){
					echo "<td bgcolor=".$bgcolor."><a class='thickbox' href='form_ocea/".$row->unit_id."?width=600&height=500' title='Reserved Unit'>".$row->unit_no."</a></td>";
