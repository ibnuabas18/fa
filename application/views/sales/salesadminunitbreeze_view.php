	...
	<div id="wrapcenter">
		<?php 
			...
			foreach($data['unit'] as $row):
				...
				if($no==$max){
					echo "<td bgcolor=".$bgcolor."><a class='thickbox' href='form_salesadmin_condotel/".$row->unit_id."?width=800&height=500' title='Reserved Unit'>".$row->unit_no."</a></td>";
					echo"<tr>";
					$no = 0;
				}else{
