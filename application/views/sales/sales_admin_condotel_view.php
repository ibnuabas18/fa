...
<body>
<div id="wrap">
	<div class="classhome"><a href="<?=site_url('sales/sales_admin_status')?>" ><< back</a></div>
	<!--<div id="wrapheader">-->
	<?
		...
		<?php 
			...
			foreach($data['unit'] as $row):
				...
				if($no==$max){
					...
					echo "<td bgcolor=".$bgcolor."><a class='thickbox' href='form_sales_admin/".$row->unit_id."?width=750&height=450' title='Status Unit'>".$row->unit_no."</a></td>";
				} 
			$no++;
			endforeach; 
			echo"</table></tr>";
