...
<script type="text/javascript">
 function loadData(type,parentId){
      ...
      $.post('<?=site_url('sales/viewmgt_status/loaddata')?>', //request ke fungsi load data di inputAP
...
$(function(){ 
	...
	//alert("tes");
	$('viewresume').load("<?=site_url('sales/viewmgtunit_status/resume')?>");
...
<div style="padding:10 0 0 10">
	<form method="post" action="<?=site_url('sales/viewmgt_status/view_mgt')?>">
...
<table>
	...
	<tr><td><input type="submit" name="save" value="View" style="width:100px"/></td>
	...
	<td><input type="submit" name="resume" id="resume" value="Resume" style="width:100px"/></td>
