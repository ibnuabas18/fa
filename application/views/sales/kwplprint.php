...
<p class="t1"><strong>PAID-00<?=$cekdt->no_sp?> </strong></p> 
<!--
...
-->
<p class="t4_2"><?=Ucfirst(toRupiah($cekdt->selling_price))?>&nbsp;Rupiah</p>
<p class="t5"></p>
<!--
...
-->
<p class="t6_2">Pembelian&nbsp; 1&nbsp; Unit&nbsp; Apartemen&nbsp;<?=$cekdt->unit_no?>&nbsp;&nbsp;a/n &nbsp; <?=$cekdt->customer_nama?></p>
<!--
...
-->
<p class="t7_2">Pelunasan Unit Apartement <?=$cekdt->unit_no?> </p>
...
<p class="t9"></p>
<p class="t10"></p>
<p class="t11"><strong><?=number_format($cekdt->selling_price)?> </strong></p>
<p class="t12"></p>
<p class="t13"><strong><?=indo_date($cekdt->tgl_paydate)?></strong>  </p>
<p class="t12"></p>
<p class="dc14"><strong><u>Susamto</u></strong></p>
<p class="dc15"><strong>Fin & Acc Manager</strong></p>
