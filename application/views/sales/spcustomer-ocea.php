			 ...
			 <tr class="sphide">
				...
				<tr class="sphide">
					...
					<td ><input type="text" name="spno" id="spno" class="xinput validate[required]"  style='width:50px' readonly></td>
						...
						<td>:</td>
						<td colspan='5'><input type="text" name="disc1" id="disc1" class="input calculate" style='width:50px' maxlength='5' ><span class="hide_x"></span><input type="hidden" name="disc2" id="disc2" class="xinput  input" style='width:50px' maxlength='5'>
						<span class="hide_x">Add Disc</span>
						<input type="text" name="adddisc" id="adddisc" class="input calculate" style='width:50px' maxlength='1' >
						</td>
				</tr>
				<tr class="sphide">
					<td>Project*</td>
