<html>
<head>
<?=link_tag(CSS_PATH.'town_sales.css')?>
...
<body>
	<div class="classhome"><a href="<?=site_url('sales/viewsalesadmin_status/viewsalesadmin_status')?>" ><< back</a></div>
	<table >	
...
<div id="wrap">	
	...
	<!--	<div class="classhome"><a href="<?//=site_url('sales/alokasi_status')?>">HOME</a></div>-->
		...
		?>
					...
					<a class='thickbox' href='form_salesadmin_town/<?=$row->unit_id?>?width=750&height=450' title='Status Unit'><?=$row->unit_no?></a>
					</div>
