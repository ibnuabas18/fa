...
<h2><font color='red' size='4'>Status Unit Ocea Condotel<hr width="150px" align="left"></font></h2>

<div style="padding:10 0 0 10">
	<form method="post" action="<?=site_url('sales/viewunitocea_status/view_unitocea')?>">
