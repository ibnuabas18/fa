...
$(function(){
	...
	grid.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 ...
			 if(id){
				 window.open("<?=site_url($module_url)?>" + '/cetakbill/' + id + '/?width='+750+'&height='+700);
			 }else{
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 window.open("<?=site_url($module_url)?>" + '/cetakpiutang/' + id + '/?width='+750+'&height='+700);
			 }else{
				 alert('Pilih baris yang ingin diedit');
			 }
		   }, 
		...
		.navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 window.open("<?=site_url($module_url)?>" + '/piutang/' + id + '/?width='+750+'&height='+700);
			 }else{
				 alert('Pilih baris yang ingin diedit');
			 }
		   }, 
