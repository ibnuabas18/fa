...
<h2><font color='red' size='4'>Cancel Unit Report <hr width="150px" align="left"></font></h2>
<form method="post" action="<?=base_url()?>sales/reportcancelunit_call/cetakcancelunit" target="_blank">
<table>
