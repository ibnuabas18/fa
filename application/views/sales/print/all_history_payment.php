				...
				$pdf->Cell(30,4,$head_nama,0,0,'L',0);
					...
					$pdf->Cell(8,4,':',4,0,'L');
						...
						#HEAD TABLE
							...
							$pdf->Cell(40,7,$head_top,1,0,'C',0);
							$pdf->Cell(30,7,'Pay Date',1,0,'C',0);
...
//					$pdf->SetXY(30,82);
			...
			$dt = $this->db->select('kwtbill_id,kwtbill_sisa,id_billing,id_paygroup,due_date,paygroup_nm,tgl_paydate,amount,kwtbill_pay,kwtbill_paydate')
...
#			var_dump($dt);
			...
			foreach($dt as $rows){								   
				...
				$pdf->Cell(40,4,$rows->paygroup_nm.' '.$n.$k,1,0,'C',0);
				$pdf->Cell(30,4,indo_date($rows->kwtbill_paydate),1,0,'C',0);
				$pdf->Cell(30,4,number_format($rows->kwtbill_pay),1,0,'C',0);
				$pdf->Cell(30,4,number_format($sisa),1,0,'C',0);
