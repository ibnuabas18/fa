<?php
			...
			if(@$cek == '1'){
				...
				ELSE{
				$rows = $this->db->query("SoldUnitProject ");
				$data = $rows->result();				
				}
				...
				require('fpdf/classreport.php');
					...
					#HEADER CONTENT
						...
						$judul 		= "STATUS UNIT SUMMARY REPORT";
						$periode	= "As Off";
			...
			$rows = $this->db->query("StatusunitReport '".$subproject."','".$type."','".$start_date."'")->row();
			
			$data1 = $this->db->query("StatusunitReport '".$subproject."','".$type."','".$start_date."'");
			...
			$pdf->Cell(20,6,'lot_no',1,0,'C',1);
			$pdf->Cell(9,6,'compute_0002',1,0,'C',1);
			$pdf->Cell(36,6,'build_up_area',1,0,'C',1);
			$pdf->Cell(28,6,'name',1,0,'C',1);
			$pdf->Cell(20,6,'disc_amt',1,0,'C',1);
			$pdf->Cell(20,6,'compute_0006',1,0,'C',1);
			#var_dump($subproject);			
			$pdf->Cell(10,6,'compute_0007',1,0,'C',1);
			$pdf->Cell(10,6,'project_no',1,0,'C',1);}
			$pdf->Cell(18,6,'sell_price',1,0,'C',1);
			$pdf->Cell(18,6,'package_amt',1,0,'C',1);
			$pdf->Cell(18,6,'list_after_amt',1,0,'C',1);
			$pdf->Cell(18,6,'list_after_tax_amt',1,0,'C',1);
			$pdf->Cell(18,6,'compute_0013',1,0,'C',1);
			$pdf->Cell(18,6,'land_area',1,0,'C',1);
			$pdf->Cell(18,6,'compute_0015',1,0,'C',1);
			...
			$pdf->Cell(20,6,$unitno,20,0,'C');
			$pdf->Cell(20,6,$paytipenm,20,0,'C');
