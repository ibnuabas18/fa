<?php
	...
	$pdf->MultiCell(200,0,$text,10,0,'L');	
		...
		$pdf->Ln(4);
			...
			if($idproject == 41011){
					...
					$pdf->Cell(55,6,'sejak tanggal Pelunasan UANG MUKA ("TANGGAL SELESAI PEMBANGUNAN")',10,0,'L',0);}
								...
								$pdf->Ln(4);
								$pdf->Cell(55,6,'01 Januari 2014 ("TANGGAL SELESAI PEMBANGUNAN").',10,0,'L',0);
								}
		...
		//	$pdf->Cell(60,6,'Reynold Marnaek',10,0,'L',0);
			...
			$pdf->Ln(4);
			$pdf->Cell(60,6,'SYARAT-SYARAT & KETENTUAN-KETENTUAN PEMESANAN terlampir sebagai satu kesatuan dan bagian integral yang tidak terpisahkan dari',10,0,'L',0);
			
			$pdf->Ln(4);
			$pdf->Cell(60,6,'SURAT PESANAN ini.',10,0,'L',0);
