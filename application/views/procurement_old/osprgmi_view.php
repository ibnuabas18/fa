...
<h2><font color='red' size='4'>Outstanding Report PR<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=site_url('procurement/print_osprgmi/print_osprpdf')?>" target="_blank">
