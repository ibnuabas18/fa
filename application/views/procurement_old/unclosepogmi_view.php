...
<h2><font color='red' size='4'>Unclose Report PO<hr width="150px" align="left"></font></h2>
<div class="printed">
<form method="post" action="<?=site_url('procurement/print_unclosepogmi/print_unclosepopdf')?>" target="_blank">
