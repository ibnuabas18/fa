...
// where a.brgpoh_id = 3
	...
	$tot = $tot + $row->harga_tot;	
						...
						$pdf->Cell(10,5,number_format($row->discnilai),1,0,'R');
						$pdf->Cell(25,5,number_format($row->harga_tot),1,0,'R');
						$pdf->Ln(5);
						$i++;
						$no++;
				}
		...
		$pdf->Cell(25,4,number_format($tot),'L'.'T'.'R',0,'R');
		$pdf->Ln(4);
		
		$pdf->SetX(5);
		$pdf->Cell(140,4,'','L'.'R',0,'R');
		$pdf->Cell(35,4,'Discount','L'.'R',0,'R');
		$pdf->Cell(25,4,number_format($row->discvnilai),'L'.'R',0,'R');
		$pdf->Ln(4);
		...
		$pdf->Cell(25,4,number_format($totsedisc),1,0,'R');
		$pdf->Ln(4);
		
		$pdf->SetX(5);
		$pdf->Cell(140,4,'','L'.'R',0,'R');
		$pdf->Cell(35,4,'PPN','L'.'T'.'R',0,'R');
		$pdf->Cell(25,4,number_format($row->ppn_nilai),1,0,'R');
		$pdf->Ln(4);
