...
<script type="text/javascript">
 ...
 function loadData(type,parentId){
      ...
      $.post('<?=site_url('sales/viewalokasi_status/loaddata')?>', //request ke fungsi load data di inputAP
...
<div style="padding:10 0 0 10">
	<form method="post" action="<?=site_url('sales/viewalokasi_status/view_alokasi')?>">
...
<table align='center'  >
	...
	<tr>
		...
		<td>
			<select name="proj" id="subproject"  class="sinput"></select>
		</td>
	</tr>
	
	<tr>
		<td class="sinput">PILIH VIEW</td>
	</tr>
	<tr>
		<td><select name='view' id='view' class="sinput" ></select><input type="checkbox" id="all" ><font size='4'>ALL PROJECT</font></td>
	</tr>
