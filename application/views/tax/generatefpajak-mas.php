...
<form action="<?php echo site_url('generatefpajak/inpajnom')?>" method="post" enctype="multipart/form-data" role="form"> 		
  	<table>  
	
		<tr>
			<td>No. AP</td>
			<td> : </td>
			<td><input type="text" name="noap" class="mytextbox" value="<?=$to->doc_no; ?>" disabled readonly /> </td>
		</tr>	
	  	<tr>
	  	...
	  	<input type="hidden" name="ppn" class="mytextbox" value="<?=$to->ppn; ?>"/>
		<input type="hidden" name="noap" class="mytextbox" value="<?=$to->doc_no; ?>"/>
		<tr>
