...
$(function(){
	...
	.	navButtonAdd('#pager',{
		   ...
		   onClickButton: function(){ 
			 var id = getSelectedID();
			 if(id){
				 window.open("<?=site_url($module_url)?>" + '/printfpaj/' + id + '/?width='+600+'&height='+240);
			 }else{
				 alert('Pilih baris yang ingin diview');
			 }
		   }, 
...
<h4><font color='#1D5987'>Generate Faktur Pajak Keluaran</font></h4>	
</center> 
...
<form action="<?php echo site_url('generatefpajakel')?>" method="post" enctype="multipart/form-data" role="form"> 		
  	<table>  
	  	<tr>
...
<form method="post" action="<?php echo base_url();?>generatefpajakel/savenum">
	<table border=1>
		<tr>
