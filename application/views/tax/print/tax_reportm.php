<?php
		...
		$cekdata = $this->db->query($sql)->result();*/
			...
			$pdf->Cell(130,5,$dat->nm_supplier,'R',0,'L',0);
			$pdf->Ln(5);

			$pdf->SetFont('Arial','',9);
			$pdf->Cell(55,5,'Alamat','L',0,'L',0);
			$pdf->Cell(5,5,':',0,0,'C',0);
			$pdf->Cell(130,5,$dat->alamat,'R',0,'L',0);
			$pdf->Ln(5);
			...
			$pdf->Cell(5,5,' : ',0,0,'C',0);
			$pdf->Cell(130,5,$dat->npwp,'R',0,'L',0);
			$pdf->Ln(5);
			...
			$pdf->Cell(110,5,$dat->descs,'L'.'R',0,'L',0);
			$pdf->Cell(65,5,number_format($dat->trx_amt),'L'.'R',0,'R',0);
			$pdf->Ln(5);
			...
			$pdf->Cell(65,5,number_format($dat->trx_amt),'L'.'T'.'R',0,'R',0);
			$pdf->Ln(5);
			...
			$pdf->Cell(65,5,number_format($dat->nilai_fakturpajak),1,0,'R',0);
			$pdf->Ln(5);
