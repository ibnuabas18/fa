...
echo form_open(site_url('deduct/kurangkontrak'), $attr);
...
?>
	...
	<table>
		...
		<tr>
			<td>No. IOM</td>
			<td>:</td>
			<td><input name='noiom' id='noiom' class='midinput' required='required'></td>
		</tr>
		</table>
	...
	<div title="Budget Alocation" style="padding:10px;">
		<table id="bgt" title="Deduct Budget" style="width:900px;height:170px"
			...
			<thead>
				<tr>
					<th field="nm_subproject" width="70px" >Project</th>	
					<th field="nm_scost" width="70px" >Structure Cost</th>	
...
<input type="submit" name="save" id="save" value="Deduction"/>
