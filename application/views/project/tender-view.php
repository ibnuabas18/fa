...
<div class="easyui-tabs" style="width:900px;height:300px;">
	...
	<div title="Material" style="padding:10px;">
		<table id="mr" title="Input Contractor" style="width:800px;height:250px"
				url="<?=site_url('tendereval/get_mr')?>/<?=$data->id_mainjob?>"
				toolbar="#toolbar2" pagination="true"
				fitColumns="true" singleSelect="true">
			<thead>
				<tr>
					<th field="product" width="50">Product</th>
					<th field="qty" width="50" editor="numberbox">QTY</th>
