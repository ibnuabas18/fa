<?php
			...
			#HEADER CONTENT
				...
				$judul 		= "Transaction LIsting By Voucher";
				$periode	= "Periode";
...
for($h = 1;$h <= 2; $i++){		
			...
			$pdf->Cell(15,10,'Voucher No.',10,0,'C',0);
			$pdf->Cell(20,10,'JU/BK/2010000001',10,0,'C',0);
			$pdf->Cell(20,10,'IDR',10,0,'C',0);
			$pdf->Ln(6);
	...
	$a = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa4";
			...
			$pdf->Cell(30,5,substr($a,0,22),10,0,'L',0);
			$pdf->Cell(78,5,substr($a,0,58),10,0,'L',0);
