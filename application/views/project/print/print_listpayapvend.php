<?php
	...
	$a = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa4";
			...
			$pdf->Cell(40,5,'Vendor',1,0,'L',0);
			$pdf->Cell(80,5,substr($a,0,72),1,0,'L',0);
			$pdf->Cell(25,5,'Cost Center',1,0,'L',0);
			$pdf->Cell(25,5,'Jenis',1,0,'C',0);
			$pdf->Cell(25,5,'No. C/G',1,0,'C',0);
			$pdf->Cell(25,5,'Tgl. Cek/B',1,0,'C',0);
			$pdf->Cell(25,5,number_format(1000000000),1,0,'R',0);
