<?php
			...
			$pdf->SetX(5);
			$pdf->SetFont('Arial','B',12);
			$pdf->Cell(40,5,'Condotel',10,0,'L');
			$pdf->Ln(5);
			
			$pdf->SetFont('Arial','',7);
			
			$pdf->SetX(5);	
			$pdf->Cell(60,5,'Land Area',10,0,'L');
			$pdf->Cell(25,5,number_format(10000000000),10,0,'L');
			
			$pdf->Ln(4);
			
			$pdf->SetX(5);	
			$pdf->Cell(60,5,'GBA',10,0,'L');
			$pdf->Cell(25,5,number_format(10000000000),10,0,'L');
			
			$pdf->Ln(4);
			
			$pdf->SetX(5);	
			$pdf->Cell(60,5,'SGFA',10,0,'L');
			$pdf->Cell(25,5,number_format(10000000000),10,0,'L');
			
			$pdf->Ln(4);
			
			$pdf->SetX(5);	
			$pdf->Cell(60,5,'SALEABLE',10,0,'L');
			$pdf->Cell(25,5,number_format(10000000000),10,0,'L');
			
			$pdf->Ln(4);
			
			$pdf->SetX(5);	
			$pdf->Cell(25,5,'Cost Of Sales',10,0,'L');
			$pdf->Cell(25,5,number_format(10000000000),10,0,'R');
