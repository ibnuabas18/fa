...
<div class="easyui-tabs" style="width:600px;height:350px;">
		...
		<div title="Payment" style="padding:10px;">
			<table width="600px">
				...
				<tr>
					<td>Contract (Incl.Tax)</td><td><input type="text" class="input" value="<?=number_format($data->contract_amount)?>"  readonly="true"/></td>
				</tr>
				<tr>	
					<td>Contract (Excl.Tax)</td><td><input type="text" class="input" value="<?#=number_format($data->contract_bftax)?>" readonly="true"/></td>
				</tr>
				<tr>	
				...
				<tr>	
					<td>PPN</td><td><input type="text" class="input" value="<?#=number_format($data->nilppn)?>" readonly="true"/></td>
				</tr>
				<tr>	
					<td>PPH</td><td><input type="text" class="input" value="<?#=number_format($data->nilpph)?>"   readonly="true"/></td>
				</tr>
...
<input type="submit" name="save" value="Unapprove"/>
<?=form_close()?>
