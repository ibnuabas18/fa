...
<?=script('jquery.formx.js')?>
	...
	<script type="text/javascript">
			...
			$('#dg').datagrid({
				...
				onExpandRow: function(index,row){
					...
					ddv.panel({
						border:false,
						cache:true,
						href:"<?=site_url('proposedbgt/showbgt_edit')?>/"+xref+"/?index="+index,
						onLoad:function(){
		...
		function saveItem(index){
			...
			var url = row.isNewRecord ? '<?=site_url('proposedbgt/update_proproj')?>' : '<?=site_url('proposedbgt/update_proproj')?>/'+row.id;
...
echo form_open(site_url('proposedbgt/save_proproj'), $attr);
?>
<input type="hidden" name="idtr" value="<?=$data->mainjob_id?>"/>
<font color='red' size='4'>Proposed Budget<hr width="150px" align="left"></font></h2>
  ...
  <table>
     ...
     <tr>
			...
			<td><input type="text" name="tgl" style="width:100px;background-color:#EFFC94" value="<?=indo_date($data->mainjob_date)?>" id="tgl" readonly="true" style="width:150px"/></td>  
	</tr>
     <tr>
			<td for="date">Approved Date</td>
			<td><input type="text" name="tgl" style="width:100px;background-color:#EFFC94" value="<?=$tgl?>" id="tgl" readonly="true" style="width:150px"/></td>  
	</tr>	
	<tr>
			<td>No.Proposed</td>
	...
	<tr id="tr1">
	   ...
	   <tr id="tr5" > 
		...
		<tr id="tr6" > 
			<td>Main Job</td>
			<td><input type="text" name="job" id="job" value="<?=$data->mainjob_desc?>"  style="width:300px"></td>
			
   </table>

<!-- GRID TABLE -->
<div class="easyui-tabs" style="width:1300px;height:270px;">
	<!--Contractor -->
	<div title="Add Detail Job" style="padding:10px;">	
		<table id="dg" title="List Detail Job" style="width:1250px;height:220px"
				url="<?=site_url('proposedbgt/get_dg')?>/<?=$data->mainjob_id?>"
				toolbar="#toolbar" pagination="true"
				fitColumns="true" singleSelect="true">
			<thead>
				<tr>
					<th field="id_trbgtproj" width="110px" hidden="true" ></th>				
					<th field="jobdet" width="110px"  >Detail Job</th>				
					<th field="proj_id" width="110px" >Project</th>				
					<th field="cost" width="110px">Structure</th>	
					<th field="subcost" width="110px">Sub.Cost</th>			
					<th field="codebgt" width="110px">Desc.BGT</th>
					<th field="totalbgt" width="110px"  editor="text" align="right">Tot.BGT</th>
					<th field="totalprop" width="110px" editor="text" align="right">Tot.Props</th>
					<th field="xblc" width="110px" editor="text" align="right">Blc.Props</th>
					<th field="amount" width="110px" editor="text" align="right">Amount.Props</th>
				</tr>
			</thead>
		</table>
	</div>	
