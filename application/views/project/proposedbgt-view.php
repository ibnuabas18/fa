  ...
  <table>
	...
	<tr id="tr1">
	   ...
	   <tr id="tr5" > 
		...
		<tr id="tr6" > 
			<td>Main Job</td>
			<td><input type="text" name="job" id="job" value="<?=$data->mainjob_desc?>" style="width:300px;background-color:#EFFC94" readonly="true" ></td>
			<td>Keterangan</td>
			<td><input type="text" name="ketprop" id="ketprop" value="<?=@$trbgt->remark_prop?>" style="width:300px;background-color:#EFFC94" readonly="true" ></td>
		</tr>
   </table>
