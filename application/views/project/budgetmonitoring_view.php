...
<h2><font color='red' size='4'>Report Budget Monitoring <hr width="150px" align="left"></font></h2>
<form method="post" action="<?=base_url()?>project/budgetmonitoring_call/budgetmonitoring" target="_blank">
<table>
