...
<form method="post" action="<?=base_url()?>project/budgetproject_call/budgetvbudget" target="_blank">
<table>
	...
	<tr>
		<td>All Project</td>
		<td><input type="hidden" name="det_rptbgt" value="0" /> <input type="checkbox" name="det_rptbgt" value="1" /></td>
