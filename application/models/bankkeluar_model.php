<?php
	class bankkeluar_model extends DBModel{
		...
		function before_fetch(){
			...
			//$status = array('1','2','3');
			//$this->db->select('a.id_plan as id_plan,e.paid_date,b.descs as descs,b.doc_no as doc_no,c.nm_supplier as nm_supplier,e.voucher as voucher,e.no_arsip as no_arsip,e.amount as amount,e.amt_balance as amt_balance,e.slipno as slipno,e.slip_date as slip_date,e.payment_date as payment_date,e.status as status');
			...
			//$this->db->select('id_plan,doc_no,voucher,no_arsip,nm_supplier,descs,amount,slipno,slip_date,payment_date,paid_date,status_ap,pt_project');
