<?php
	class spk_model extends DBModel{
		...
		$project = array('41012','41011','1');
			$this->db->select('(case when a.currency="usd" then a.contract_amount*9000 else a.contract_amount end) as contract_amount,telepon,sign_1,sign_2,sign1_level,sign2_level,c.mainjob_total,c.mainjob_desc,b.no_tendeva,a.id_flag,a.id_kontrak,a.currency,a.no_spk,a.no_kontrak,f.kontak,f.nm_supplier,f.alamat,b.job,a.start_date,a.end_date');
